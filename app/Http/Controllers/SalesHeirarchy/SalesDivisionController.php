...
class SalesDivisionController extends Controller
{
    ...
    public function index()
    {
        if ($this->userMenu->wsmu_vsbl) {
            $gDivision = GovtDivision::where('cont_id', '=', $this->currentUser->employee()->cont_id)->get();
...
// `attr1`, `attr2`, `attr3`, `attr4`
    ...
    public function show($id)
    {
        if ($this->userMenu->wsmu_read) {
            $gDivision = GovtDivision::findorfail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        //$company->country_id = $this->currentUser->employee()->cont_id;
