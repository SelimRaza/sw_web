       ...
       if($dirg_id){
        ...
        switch($reportType){
            ...
            case "sr_routed_outlet":
                ...
                t6.site_code OUTLET_CODE,t6.site_name OUTLET_NAME,t6.site_mob1 OUTLET_MOBILE,t6.site_adrs OUTLET_ADRS, t1.rpln_day RPLN_DAY,
                t12.otcg_name OUTLET_CAT,t11.cont_name OUTLET_NATIONALITY,t6.created_at OPEN_TIME
                FROM tl_rpln t1
                ...
                INNER JOIN tm_otcg t12 ON t6.otcg_id=t12.id
                LEFT JOIN tl_scmp t10 ON t5.site_id=t10.site_id
                LEFT JOIN tl_cont t11 ON t10.cont_id=t11.id
                ";
                break;
