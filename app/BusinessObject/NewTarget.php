...
class NewTarget extends Model implements FromCollection, WithHeadings, ToArray, WithHeadingRow
{
    ...
    {
        $target_header = array( 'ctn_price','sku_id','sku_code', 'ctn_size', 'year', 'month');
    ...
    public function array(array $array)
    {
        try{
            ...
            if (!empty($insert)) {
                //dd($insert);
                foreach (array_chunk($insert,800) as $t) {
