  ...
  public function country($id)
    {
        ...
        array_push($this->array, (object)array('id' => 2, 'cont_name' => 'PRAN', 'memo_title' => 'Invoice','memo_sub_title' => 'Thanks for staying with us','cont_code' => 'C0002', 'cont_tzon' => 'asia/dhaka', 'cont_conn' => 'myprg_pran','cont_con2' => '', 'cont_imgf' => 'bdp', 'cont_dgit' => '2','cont_ogdt' => '99999', 'cont_cncy' => 'BDT','cncy_sym' => '৳', 'cont_rund' => '4', 'GCKCD' =>90,'GTCCD' => 7,'GTCRD' => 2,'RTBO' => 0,'min_oamt' =>0, 'module_type' => 1));
        array_push($this->array, (object)array('id' => 3, 'cont_name' => 'UAE', 'memo_title' => 'Order Memo(For Order Purpose Only)','memo_sub_title' => '','cont_code' => 'C0003', 'cont_tzon' => 'asia/dubai', 'cont_conn' => 'mydb_uae','cont_con2' => 'uae_live', 'cont_imgf' => 'uae', 'cont_dgit' => '2','cont_ogdt' => '99999', 'cont_cncy' => 'AED','cncy_sym' => '', 'cont_rund' => '2','GCKCD' =>30,'GTCCD' => 7,'GTCRD' => 2,'RTBO' => 1, 'min_oamt' =>30,'module_type' => 2));
        ...
        array_push($this->array, (object)array('id' => 15, 'cont_name' => 'KSA','memo_title' => 'Memo(TAKHYYR FOODS TRADING COMPANY)','memo_sub_title' => 'Thanks for staying with us', 'cont_code' => 'C0015', 'cont_tzon' => 'Asia/Riyadh', 'cont_conn' => 'myprg_ksa','cont_con2' => 'ksa_live', 'cont_imgf' => 'ksa', 'cont_dgit' => '4', 'cont_ogdt' => '99999','cont_cncy' => 'SR', 'cncy_sym' => 'SR','cont_rund' => '2','GCKCD' =>30,'GTCCD' => 7,'GTCRD' => 2,'RTBO' => 1, 'min_oamt' =>30,'module_type' => 2));
        ...
        array_push($this->array, (object)array('id' => 27, 'cont_name' => 'Australia','memo_title' => 'Memo(COMPANY)','memo_sub_title' => 'Thanks for staying with us', 'cont_code' => 'C0027', 'cont_tzon' => 'Australia/Sydney', 'cont_conn' => 'mydb_aus','cont_con2' => 'aus_live', 'cont_imgf' => 'aus', 'cont_dgit' => '4', 'cont_ogdt' => '99999','cont_cncy' => 'AUD', 'cncy_sym' => 'A$','cont_rund' => '2','GCKCD' =>30,'GTCCD' => 7,'GTCRD' => 2,'RTBO' => 0, 'min_oamt' =>0, 'module_type' => 1));
   ...
   public function country1($id)
    ...
    public function currentUserDB($id){
        ...
        array_push($this->db_array, (object)array('id' => 27,'db_name'=>'mydb_aus'));
