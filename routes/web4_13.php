...
Route::match(['GET', 'POST'], 'promotion_sp/extend_date/{id}', 'Promotion\PromotionController@promotionSpShow');
...
Route::resource('new-sku-list', 'MasterData\SKUControllerNew@newSku');
...
Route::match(['GET', 'POST'], 'new_sku', 'MasterData\SKUControllerNew@newSku');
