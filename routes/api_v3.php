...
Route::group(['middleware' => ['VerifyAPIKey']], function () {
    ...
    Route::post('login_sw', 'API\v3\MobileAPI@login_sw');
    ...
    Route::post('searchDataList_New', 'API\v2\OrderModuleData@searchDataList_New');
    Route::post('user_wise_msp_item_report', 'API\v2\OrderModuleData@user_wise_msp_item_report');
    Route::post('user_wise_all_item_report', 'API\v2\OrderModuleData@user_wise_all_item_report');
    Route::post('user_wise_summary_report', 'API\v2\OrderModuleData@user_wise_summary_report');
    Route::post('user_role_wise_summary_report', 'API\v2\OrderModuleData@user_role_wise_summary_report');
    //
    ...
    Route::post('getVanpending_collection', 'API\v2\OrderModuleDataUAE@getVanpending_collection');
