...
class FmsOrder  extends Model implements WithHeadings, ToArray, WithHeadingRow
{
    ...
    public function getTotalOrderAmount($ordm_id){
        $data=DB::connection($this->db)->select("SELECT 
                ...
                FROM `tt_ordd_sv` where ordm_id=$ordm_id");
        return $data;
