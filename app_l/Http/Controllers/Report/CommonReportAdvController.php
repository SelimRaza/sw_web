...
class CommonReportAdvController extends Controller
{
    ...
    public function index()
    {
        ...
        // return view('report.summary_report.common_report_adv',['acmp'=>$acmp,'region'=>$region,'dsct'=>$dsct,'dsct1'=>$dsct,'role_id'=>$user_role_id,
        //             'emid'=>$empId,'zone'=>$zone,'asset'=>$asset,'depo_list'=>$depo_list]);
        return view('report.summary_report.common_report',['acmp'=>$acmp,'region'=>$region,'dsct'=>$dsct,'dsct1'=>$dsct,'role_id'=>$user_role_id,
                    'emid'=>$empId,'zone'=>$zone,'asset'=>$asset,'depo_list'=>$depo_list]);
    }
