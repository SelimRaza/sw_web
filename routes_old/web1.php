...
Route::get('getGvtTrackingRecord', 'Report\CommonReportController@getTrackingRecordGvt');
...
Route::get('/depot/create/dealer/login', 'Depot\DepotController@filterDepotddddddddd');
Route::post('/depot/create/dealer/login', 'Depot\DepotController@filterDepotddddddddd');
...
Route::match(['GET', 'POST'], 'new_sku', 'MasterData\SKUController@newSku');
...
Route::get('own_unit_filter_leaders','LeaderBoard\LeaderBoardController@filterOwnUnitLeaderBoard');
