    ...
    var FilterCollection = function () {
        ...
        FilterCollection.prototype.sort = function (column, order, table, options) {
            ...
            rows.sort(function (a, b) {
                // console.log(a.children.length, column)
                var A = a.children.length > 0 ? a.children[column].innerText.toUpperCase() : '';
                var B = b.children.length > 0 ? b.children[column].innerText.toUpperCase() : '';
