                         ...
                         @auth
                                    <div class="col-md-2">
                                        <div class="menu_div" style=" background-color:#6491EA !important;color:white !important;">
                                            <a  href="{{route('dashboard')}}" style="font-size:18px!important;color:white !important;">Dashboard<span
                                                    class=""></span></a>
                                        </div>
                            ...
                            <!-- @foreach($menus as $item)
                                    <div class="col-md-2">
                                        ...
                                        <a href="{{ URL::to('/report')}}" style="font-size:18px!important;;color:white !important;"> {{ $item->wmnu_name}} <span
                                                    ></span></a>
                                        @else
                                            
                                            @if(count($item->get_user_submenu())>0)
                                            <i class="{{$item->wmnu_icon}}"></i>
                                                <a  href="#" style="font-size:18px!important;color:white !important;" onclick="openModal('{{ $item->get_user_submenu() }}','{{ $item->wmnu_name }}');"> {{ $item->wmnu_name}} <span
                                                        class=""></span></a>
                                            @endif
                                        @endif
                                        </div>
