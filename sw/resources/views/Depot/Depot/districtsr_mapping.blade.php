                    ...
                    <ol class="breadcrumb">
                        ...
                        @if($permission->wsmu_crat)
                            <li class="label-success">
                                <a href="{{ URL::to('/district/sr/mapping/format')}}">District Employee
                                    Format</a>
                            </li>
                        @endif
                    </ol>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate
                                              ...
                                              action="{{ URL::to('district/sr/mapping/store')}}"
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                              action="{{URL::to('/district/sr/mapping/data/export')}}"
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                              action="{{URL::to('district/sr/mapping')}}"
                              method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" id="_token" value="<?php echo csrf_token(); ?>">
                            {{csrf_field()}}
                            <div class="row">
    ...
    <script type="text/javascript">
        ...
        function getUserThana(){
          ...
          if(staff_code==""){
            ...
            var url = "{{url('/district/sr/mapping/data/view')}}/"+staff_code;
        ...
        function deleteSRFromThana(id){
          ...
          if(x){
             ...
             $.ajax({
                ...
                type: "GET",
                url: "{{url('district/sr/mapping/data/delete')}}/"+id,
