                    ...
                    <ol class="breadcrumb">
                        ...
                        @if($permission->wsmu_crat)
                            <li class="label-success">
                                <a href="{{ URL::to('/ThanSR/depotEmployeeMappingUploadFormat')}}">Thana Employee
                                    Format</a>
                            </li>
                        @endif
                    </ol>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate
                                              ...
                                              action="{{ URL::to('/ThanSR/depotEmployeeMappingUpload')}}"
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                              action="{{URL::to('/ThanSR/dataExportThanSRMappingInfotData')}}"
    ...
    <script type="text/javascript">
        ...
        function getUserThana(){
          ...
          if(staff_code==""){
            ...
            var url = "{{url('/json/get/sr_wise/thana/list')}}/"+staff_code;
        ...
        function deleteSRFromThana(id){
          ...
          if(x){
             ...
             $.ajax({
                ...
                type: "GET",
                url: "{{url('/json/delete/sr_wise/thana/list')}}/"+id,
