...
@section('content')
            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>All Attendance Report</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="col-md-12">
                    <div style="padding: 10px;">
                        ...
                        <div align="right">
                            ...
                            <button onclick="exportTableToCSV('attendance_summary_report_<?php echo date('Y_m_d'); ?>.csv')"
    ...
    <script type="text/javascript">
        ...
        function filterData() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ URL::to('/')}}/attendance/filterAttendanceSymmary",
                data: {
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            '<td>' + data[i].date + '</td>' +
                            '<td>' + data[i].data_count + '</td>' +
                            '<td>' + data[i].start_time + '</td>' +
                            "<td>" + data[i].end_time + "</td>" +
                            '<td>' + data[i].address + '</td>' +
                            "<td><a target='_blank' href='{{ URL::to('/')}}/attendance/summaryDetails/" + data[i].emp_id + "/" + data[i].date + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Detials </a></td>" +
                            "<td><a target='_blank' href='{{ URL::to('/')}}/attendance/summaryLocation/" + data[i].emp_id + "/" + data[i].date + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Attendance In Map </a></td>" +
                            "<td><a target='_blank' href='{{ URL::to('/')}}/attendance/summaryLocationAll/" + data[i].emp_id + "/" + data[i].date + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Activity In Map </a></td>" +
                            '</tr>';
                        count++;
                    }
