        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                                            ...
                                            <div id="sr_report"
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="reportType"
                                                                id="reportType"
                                                               value="sr_history"/> SR Activity Map
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                            ...
                                            <div id="order_report"
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="reportType"
                                                               id="reportType"
                                                               value="class_wise_order_report_amt"/> Class Wise Order
                                                        Report (amount)
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="reportType"
                                                               id="reportType"
                                                               value="class_wise_order_report_memo"/> Class Wise Order
                                                        Report (memo)
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="reportType"
                                                               id="reportType"
                                                               value="cat_wise_order_report_amt"/> Category Wise Order
                                                        Report (amount)
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="reportType"
                                                               id="reportType"
                                                               value="cat_wise_order_report_memo"/> Category Wise Order
                                                        Report (memo)
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 ">
                                        ...
                                        <div class="col-md-12 col-sm-12" style="height: 263px;">
                                            ...
                                            <div id="history" class="form-row animate__animated animate__zoomIn">
                                                ...
                                                <div class="form-group col-md-6 start_date_div_h" style="display:none;">
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12"
                                                           for="start_date_h">Date<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <input type="text" class="form-control in_tg start_date"
                                                               name="start_date_h"
                                                ...
                                                <div class="form-group col-md-6 ">
                                                    <label class="control-label col-md-4 col-sm-4 col-xs-12"
                                                           for="sr_id_h">Select SR<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                    ...
                    <div id="tablediv_sr_wise_item_summary_report">
                        <div class="x_panel">
                    ...
                    <div id="tablediv_attendance_report">
                        <div class="x_panel">
                    ...
                    <div id="tablediv_order_details_report">
                        <div class="x_panel">
                ...
                <!-- zone wise order delivery summary -->
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12" style="height:700px;overflow: auto;">
                                    ...
                                    <table id="datatablesa" class="table table-bordered table-responsive"
                                        ...
                                        <tr id="class_wise_order_summary_amount_headings"
                                            style="position:sticky; inset-block-start:0;">
                    ...
                    <div id="tblDiv_requested_report">
                        <div class="x_panel">
        ...
        <script type="text/javascript">
            ...
            function getDiggingReport(emp_tracking_hierarchy) {
                ...
                if (emp_tracking_hierarchy == 'emp_tracking_sales_hierarchy') {
                    ...
                    $('#period').attr('onchange', 'getDateWiseUserReport(this.value,1)');
                    $.ajax({
                        type: "GET",
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            for (var i = 0; i < data.slgp.length; i++) {
                                head1 += '<th colspan="4" style="text-align:center;">' + data.slgp[i]['slgp_name'] + '</th>';
                                sub_head += '<th>Outlet</th>'+'<th>Visit</th>' + '<th>Memo</th>'+ '<th>Strike Rate(%)</th>';
                            }
                            head1 += '</tr>';
                            sub_head += '</tr>';
                            for (var i = 0; i < data.data.length; i++) {
                                s_rate=0;
                                if(data.data[i]['slgpv'] !=0){
                                    visit_handle=parseInt(data.data[i]['slgpv']);
                                }
                                t_outlet=t_outlet+parseInt(data.data[i]['total_outlet']);
                                t_slg_out=t_slg_out+parseInt(data.data[i]['slgpOlt']);
                                t_visit+=parseInt(data.data[i]['slgpv']);
                                t_memo+=parseInt(data.data[i]['slgpm']);
                                s_rate=(parseInt(data.data[i]['slgpm'])/visit_handle*100).toFixed(2);
                                t_s_rate+=parseInt(s_rate);
                                html += '<tr>' +
                                    '<td>' + data.data[i]['disn_name'] + '</td>' +
                                    '<td>' + data.data[i]['total_outlet'] + '</td>';
                                dp_cnt += '<li><a href="#" onclick="getGvtDeeperData(this)" slgp_id="'+slgp_id+'" stage="0"  id="' + data.data[i]['disn_id'] + '">' + ' ' + data.data[i]['disn_name'] + ' ⥤&nbsp;&nbsp; ' + '</a></li>';
                                html += '<td>' + data.data[i]['slgpOlt'] + '</td>' +
                                        '<td>' + data.data[i]['slgpv'] + '</td>'+
                                        '<td>' + data.data[i]['slgpm'] + '</td>'+
                                        '<td>' + s_rate+ '</td>';
                                html += '</tr>';
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (reportType == "sr_history") {
                            ...
                            footer += '<tr><th>Total</th><th></th><th></th><th></th>' +
                                '<th>' + t_olt + '</th>' +
                                '<th>' + t_visit + '</th>' +
                                '<th>'+t_ro+'</th>' +
                                '<th>' +t_wr+ '</th>' +
                        ...
                        $('#ajax_load').css('display', 'none');
                        Swal.fire({
                                text: 'Please provide valid SR ID',
                            })
                        console.log(error);
                    }
                });
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGHAvVAeNHTkWUUnGsXpbA6AK3GWbFByg&callback=myMap"></script>
