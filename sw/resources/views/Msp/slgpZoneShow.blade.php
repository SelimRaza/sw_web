                            ...
                            <table id="datatabless" class="table search-table font_color" data-page-length='50'>
                                ...
                                <tr>
                                    ...
                                    @if($permission->wsmu_delt)
                                            <a href="{{route('mspslgpzone.destroy',['id'=>$d->id,'mspm_id'=>$d->mspm_id])}}"
                                                class="btn btn-danger btn-xs"  value="{{$d->id}}" dfdm_id="{{$d->mspm_id}}"><i class="fa fa-destroy"></i> Remove Zone
                                            </a>
                                    @endif
                                    </td>
                                </tr>
