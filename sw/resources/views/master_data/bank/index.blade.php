                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            @if($permission->wsmu_crat)
                                ...
                                <a class="btn btn-success btn-sm" href="{{ URL::to('/bank/create')}}"><span
                            ...
                            <table id="datatables" class="table table-search font_color">
                                ...
                                @foreach($data as $index=>$data1)
                                    <tr class="tbl_body_gray">
                                        ...
                                        <td>{{$data1->bank_code}}</td>
                                        <td>
                                            @if($permission->wsmu_delt)
                                                <form style="display:inline"
                                                      action="{{route('bank.destroy',$data1->id)}}"
