...
@section('content')
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{route('route.store')}}"
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="company_id" id="company_id" required>
                                            ...
                                            @foreach ($companies as $company)
                                                <option value="{{ $company->id }}">{{ ucfirst($company->acmp_name) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
    ...
    <script>
        const base_id = '{{ old('base_id') }}';
        const company_id = '{{ old('company_id') }}';
        if (base_id !== '') {
            $('#base_id').val(base_id);
        }
        if (company_id !== '') {
