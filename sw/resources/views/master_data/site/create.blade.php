...
@section('content')
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_name" name="site_name" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_name')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_code" name="site_code" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_code')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_olnm" name="site_olnm" class="form-control col-md-7 col-xs-12"
                                                   ...
                                                   placeholder="Ln Name"  type="text"  value="{{old('site_olnm')}}"
                                                   step="1">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_adrs" name="site_adrs" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"
                                                   placeholder="Address"  type="text"  value="{{old('site_adrs')}}"
                                                   step="1">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_olad" name="site_olad"
                                                   ...
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_olad')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_ownm" name="site_ownm"
                                                   class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_ownm')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_olon" name="site_olon"
                                                   class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_olon')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_mob1" name="site_mob1" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_mob1')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_mob2" name="site_mob2" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_mob2')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_emal" name="site_emal" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"  value="{{old('site_emal')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_reg" name="site_reg" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2" value="{{old('site_reg')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_hsno" name="site_hsno" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2" value="{{old('site_hsno')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_vtrn" name="site_vtrn" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2" value="{{old('site_vtrn')}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="site_vsts" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2" {{ old('site_vsts') == 'on' ? 'checked' : '' }}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const mktm_id = '{{ old('mktm_id') }}';
            const scnl_id = '{{ old('scnl_id') }}';
            const otcg_id = '{{ old('otcg_id') }}';
            if(mktm_id !== '') {
                $('#mktm_id').val(mktm_id);
            }
            if(scnl_id !== '') {
