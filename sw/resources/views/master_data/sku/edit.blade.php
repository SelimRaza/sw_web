...
@section('content')
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="{{route('sku.update',$sku->id)}}" enctype="multipart/form-data"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <div class="col-md-6">
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="name" class="form-control col-md-7 col-xs-12"
                                                   ...
                                                   name="amim_name" value="{{$sku->amim_name}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ln_name" class="form-control col-md-7 col-xs-12"
                                                   name="amim_code" value="{{$sku->amim_code}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ln_name" class="form-control col-md-7 col-xs-12"
                                                   name="amim_olin" value="{{$sku->amim_olin}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ln_name" class="form-control col-md-7 col-xs-12"
                                                   name="amim_bcod" value="{{$sku->amim_bcod}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ln_name" class="form-control col-md-7 col-xs-12"
                                                   name="amin_snme" value="{{$sku->amin_snme}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ln_name" class="form-control col-md-7 col-xs-12"
                                                   name="amim_tkns" value="{{$sku->amim_tkns}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ln_name" class="form-control col-md-7 col-xs-12"
                                                   name="amim_pexc" value="{{$sku->amim_pexc}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input id="ln_name" class="form-control col-md-7 col-xs-12"
                                                   name="amim_pvat" value="{{$sku->amim_pvat}}"
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="cont_id" id="cont_id"
                                                ...
                                                @foreach ($country as $cnt)
                                                    ...
                                                    <option value="{{ $cnt->id }}" {{$icmp[0]->cont_id==$cnt->id?'selected':''}}>{{ $cnt->cont_code.'-'.$cnt->cont_name }}</option>
    ...
    <script>
        $(document).ready(function () {
            ...
            const itcl_id = '{{ $sku->itcl_id }}';
            const itsg_id = '{{ $sku->itsg_id }}';
            const amim_runt = '{{ $sku->amim_runt }}';
            const amim_dunt = '{{ $sku->amim_dunt }}';
            const amim_acmp = '{{ $sku->amim_acmp }}';
            if (itcl_id !== '') {
                $('#itcl_id').val(itcl_id);
            }
            if (itsg_id !== '') {
