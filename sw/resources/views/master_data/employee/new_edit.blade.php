           ...
           <div class="item form-group">
              ...
              <div class="col-md-2 col-sm-2 col-xs-6">
                  <input id="allowed_distance" class="form-control col-md-7 col-xs-12 "
                         name="allowed_distance" value="{{$employee->aemp_aldt}}"
               ...
               <div class="col-md-2 col-sm-2 col-xs-6">
                    <select class="form-control select2" name="amng_id" id="amng_id" required>
                      @foreach ($appMenuGroup as $appMenuGroup1)
                          @if($appMenuGroup1->id ==$employee->amng_id)
          ...
          <div class="col-xs-12 col-md-5 col-sm-5 col-md-offset-2 col-sm-offset-2">
            <div class="col-sm-12 col-md-4 col-xs-12">
              ...
              @if($permission->wsmu_delt)
                  <input class="btn btn-danger btn-sm" onclick="empActvInactv()" id="empBtn" value="{{$employee->lfcl_id==1?'Active':'Inactive'}}" type="button"></input>
              @endif
                    ...
                    <table class="table table-striped projects">
                        ...
                        <td>
                           <!--  <input type="text" class="form-control" name="acmp_code"
                                   placeholder="Company Code" value="{{old('acmp_code')}}"> -->
                            <select class="form-control" name="acmp_code" id="acmp_code" required>
                                @foreach ($acmp_list as $acmp)
                                    <option value="{{ $acmp->acmp_code}}">{{ ucfirst($acmp->acmp_name) }}</option>
                                @endforeach
                            </select>
                        </td>
                ...
                <table  class="table table-striped table-bordered"
                    ...
                    @foreach ($companyMapping as $companyMapping1)
                        <tr>
                            ...
                            <td>
                                <a href="#" id="{{$companyMapping1->id}}" class="btn btn-danger btn-xs" onclick="deleteCompany(this)">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                        ...
                        <td>
                            <select class="form-control"name="slgp_code" id="slgp_code" required  onchange="getPriceList(this.value)">
                                ...
                                @foreach ($slgp_list as $slgp)
                                    <option value="{{ $slgp->slgp_code}}">{{ ucfirst($slgp->slgp_name) }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <select class="form-control" name="zone_code" id="zone_code" required>
                                ...
                                @foreach ($zone_list as $zone)
                                    <option value="{{ $zone->zone_code}}">{{ ucfirst($zone->zone_name) }}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                ...
                <table id="data_table" class="table table-striped table-bordered"
                    ...
                    @foreach ($salesGroupMapping as $salesGroupMapping1)
                        <tr>
                            ...
                            <td>
                            <a href="#" id="{{$salesGroupMapping1->id}}" class="btn btn-danger btn-xs" onclick="deleteSlgp(this)">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                    ...
                    <table class="table table-striped projects">
                        ...
                        <td>
                            <input type="text" class="form-control" name="dlrm_code" id="dlrm_code"
                                   placeholder="Depot Code" value="{{old('dlrm_code')}}">
                        </td>
                        <td>
                ...
                <table id="data_table" class="table table-striped table-bordered"
                    ...
                    @foreach ($depotMapping as $depotMapping1)
                        <tr>
                            ...
                            <td>
                                <a href="#" id="{{$depotMapping1->id}}" class="btn btn-danger btn-xs" onclick="deleteEmpDlr(this)">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="x_content" class="form-horizontal form-label-left">
            ...
            <div class="row">
                <form style="display:inline"
                      action="{{ URL::to('employee/aemp_rpln_add/'.$employee->id)}}"
                ...
                <table id="data_table" class="table table-striped table-bordered"
                    ...
                    @foreach ($routePlanMapping as $routePlanMapping1)
                        <tr>
                            ...
                            <td>
                                <a href="#" id="{{$routePlanMapping1->rpln_id}}" class="btn btn-danger btn-xs" onclick="deleteEmpRoutePlan(this)">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                ...
                <table id="data_table" class="table table-striped table-bordered"
                    ...
                    @foreach ($zoneGroupMapping as $zoneGroupMapping1)
                        <tr>
                            ...
                            <td>
                                <a href="#" id="{{$zoneGroupMapping1->id}}" class="btn btn-danger btn-xs" onclick="deleteZoneGroupMapping(this)">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
...
$.ajax({
       type:'GET',
       url: "{{URL::to('load/employeeData') }}/"+id,
       cache: false,
       success: function (data) {
...
function addEmpRoutePlan(){
    ...
    $.ajax({
        type:'post',
        url:"{{URL::to('/')}}/add/empRoutePlan/"+id,
        data:{
            day_name:day_name,
            rout_code:rout_code,
            _token:_token
...
function deleteEmpRoutePlan(v){
    ...
    if (willDelete) {
        $.ajax({
      type:'get',
      url: "{{ URL::to('/')}}/delete/empRoutePlan/"+id+"/"+eid,
      cache: false,
      dataType: "json",
      success: function (data) {
        $('#route_list_cont').empty();
