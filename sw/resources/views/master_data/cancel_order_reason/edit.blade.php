        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Edit Order Cancel Reason</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h4><strong>Order Cancel Reason</strong></h4>
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">

                            <form class="form-horizontal form-label-left"
                                  action="{{route('cancel_order_reason.update',$data->id)}}"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input id="ocrs_name" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2" name="ocrs_name"
                                                   value="{{$data->ocrs_name}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <input id="ocrs_code" class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2" name="ocrs_code"
                                                   value="{{$data->ocrs_code}}"
