                    ...
                    <ol class="breadcrumb">
                        ...
                        @if($permission->wsmu_crat)
                            <li class="label-success">
                                <a href="{{ URL::to('/company/companyEmployeeMappingUploadFormat')}}">Company Employee
                                    Format</a>
                            </li>
                        @endif
                    </ol>
                    ...
                    @if($permission->wsmu_updt)
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>{{$company->acmp_name}}
                                            <small>{{$company->acmp_code}}</small>
                                        </h2>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate
                                              ...
                                              action="{{ URL::to('company/emp_add/'.$company->id)}}"
                                              method="GET">
                                            {{csrf_field()}}
                                            {{method_field('PUT')}}
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate
                                              class="form-horizontal form-label-left"
                                              action="{{ URL::to('/company/companyEmployeeMappingUpload')}}"
                                ...
                                <div class="x_content">
                                    ...
                                    <table class="table table-striped projects">
                                        ...
                                        @foreach($companyEmployees as $index=>$companyEmployee)
                                            <tr>
                                                <td>{{$index+1}}</td>
                                                <td>{{$companyEmployee->aemp_name}}</td>
                                                <td>{{$companyEmployee->aemp_usnm}}</td>
                                                <td>
                                                    <form style="display:inline"
                                                          action="{{ URL::to('company/emp_delete/'.$companyEmployee->id)}}"
