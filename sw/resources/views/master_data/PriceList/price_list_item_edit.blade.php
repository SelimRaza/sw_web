            ...
            <div class="page-title">
                <div class="title_left">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="label-success">
                            <a href="{{ URL::to('/price_list/sku/'.$priceList->id)}}">Price List Item</a>
                        </li>
                        <li>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="{{ URL::to('price_list/sku_item_edit/'.$priceListDetails->id)}}"
                                  method="POST">
                                {{csrf_field()}}
                                {{method_field('POST')}}
                                <div class="col-md-6">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   ...
                                                   name="pldt_dppr"
                                                   value="{{$priceListDetails->pldt_dppr*$priceListDetails->amim_duft}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"
                                                   name="pldt_tppr"
                                                   value="{{$priceListDetails->pldt_tppr*$priceListDetails->amim_duft}}"
                                                   placeholder="TP per
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   ...
                                                   name="amim_duft"
                                                   min="1"
                                                   value="{{$priceListDetails->amim_duft}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"
                                                   name="pldt_snme"
                                                   value="{{$priceListDetails->pldt_snme}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"
                                                   name="pldt_dgpr"
                                                   value="{{$priceListDetails->pldt_dgpr*$priceListDetails->amim_duft}}"
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"
                                                   name="pldt_tpgp"
                                                   value="{{$priceListDetails->pldt_tpgp*$priceListDetails->amim_duft}}"
                                                   placeholder="TP
                                                        GRV
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12"
                                                   data-validate-length-range="6" data-validate-words="2"
                                                   name="pldt_mrpp"
                                                   value="{{$priceListDetails->pldt_mrpp*$priceListDetails->amim_duft}}"
