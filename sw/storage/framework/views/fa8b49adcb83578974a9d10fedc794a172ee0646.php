    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                ...
                <form action="<?php echo e(URL::to('/market')); ?>" method="get">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <?php if($permission->wsmu_crat): ?>
                                <a class="btn btn-success btn-sm" href="<?php echo e(URL::to('/market/create')); ?>"><span
                                            class="fa fa-plus-circle" style="color: white; font-size: 1.3em"></span>&nbsp;&nbsp;<b>Add
                                        New</b></a>

                                        <a class="btn btn-danger btn-sm" style="float: right" href="<?php echo e(URL::to('getAllMarket')); ?>"><span
                        ...
                        <div class="x_content">
                            <?php echo e($markets->appends(Request::only('search_text'))->links()); ?>
                            ...
                            <table id="datatabled" class="table search-table font_color" data-page-length='500'>
                                ...
                                <tbody>
                                <?php $__currentLoopData = $markets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $market): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="tbl_body_gray">
                                        <td  class="cell_left_border"><?php echo e($index+1); ?></td>
                                        <td><?php echo e($market->mktm_id); ?></td>
                                        <td><?php echo e($market->mktm_name); ?></td>
                                        <td><?php echo e($market->mktm_code); ?></td>
                                        <td><?php echo e($market->ward_name); ?></td>
                                        <td>
                                            <?php if($permission->wsmu_delt): ?>
                                                <form style="display:inline"
                                                      action="<?php echo e(route('market.destroy',$market->mktm_id)); ?>"
                                        ...
                                        <td>
                                            <?php if($permission->wsmu_read): ?>
                                                <a href="<?php echo e(route('market.show',$market->mktm_id)); ?>"
                                                   class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View
                                                </a>
                                            <?php endif; ?>
                                            <?php if($permission->wsmu_updt): ?>
                                                <a href="<?php echo e(route('market.edit',$market->mktm_id)); ?>"
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/market/index.blade.php ENDPATH**/ ?>