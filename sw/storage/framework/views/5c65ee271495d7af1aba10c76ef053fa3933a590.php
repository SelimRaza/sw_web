            ...
            <div class="row">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="<?php echo e(URL::to('/new_target/uploadFormatGen')); ?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="control-label col-md-3 col-sm-3 col-xs-3"
                                                    ...
                                                    <?php $__currentLoopData = $priceLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priceList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($priceList->id); ?>"><?php echo e($priceList->name.' ('.$priceList->code.')'); ?></option>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <form class="form-horizontal form-label-left"
                                  action="<?php echo e(URL::to('/new_target/uploadInsert')); ?>"
                                  method="post" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <form class="form-horizontal form-label-left"
                                  action="<?php echo e(URL::to('/new_target2/uploadInsert')); ?>"
                                  method="post" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>


                                <a href="<?php echo e(URL::to('new_target2/uploadFormatGen')); ?>">Download Format</a>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">File<span
                                                class="required">*</span>
                                    </label>
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/Target/NewTarget/new_target_format.blade.php ENDPATH**/ ?>