...
<?php $__env->startSection('content'); ?>
            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="label-success">
                            <a href="<?php echo e(URL::to('/market')); ?>">All Market</a>
                        </li>
                        <li >
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content" id="add_market">
                            ...
                            <form class="form-horizontal form-label-left" action="<?php echo e(route('market.store')); ?>"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="division_id" id="division_id"
                                            ...
                                            <?php $__currentLoopData = $govDivisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $govDivision): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($govDivision->id); ?>"><?php echo e($govDivision->disn_name); ?></option>
                        ...
                        <div class="x_content" id="upload_market">
                            <form class="form-horizontal form-label-left"
                                  action="<?php echo e(URL::to('/data_upload/marketMasterUpload')); ?>"
                                  method="post" enctype="multipart/form-data">
                                <?php echo e(csrf_field()); ?>
                                ...
                                <div class="ln_solid"></div>
                                <div class="col-md-12">
                                    <a class="btn btn-danger btn-sm" href="<?php echo e(URL::to('/data_upload/marketUploadFormat')); ?>"><span
    ...
    <script>
        ...
        function filterDistrict() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/site/filterDistrict",
                data: {
                    fk_id: fk_id,
                    _token: _token
                },
        ...
        function filterThana() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/site/filterThana",
                data: {
                    fk_id: fk_id,
                    _token: _token
                },
        ...
        function filterWard() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/site/filterWard",
                data: {
                    fk_id: fk_id,
                    _token: _token
                },
        ...
        function filterMarket() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/site/filterMarket",
                data: {
                    fk_id: fk_id,
                    _token: _token
                },
        ...
        function filterSubChannel() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/site/filterSubChannel",
                data: {
                    fk_id: fk_id,
                    _token: _token
                },
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/market/create.blade.php ENDPATH**/ ?>