                                    ...
                                    <table class="table table-striped projects">
                                        ...
                                        <?php $__currentLoopData = $bySrdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$bySrdata1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($bySrdata1->user_name); ?></td>
                                                ...
                                                <td>
                                                  <a href="<?php echo e(URL('target/removeBySr',[$bySrdata1->aemp_id,$bySrdata1->year,$bySrdata1->month,$manager_id])); ?>" class="btn btn-danger btn-sm"><i class="fa fa-pencil"></i>Remove</a>
                                                </td>
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/Target/target_by_sr.blade.php ENDPATH**/ ?>