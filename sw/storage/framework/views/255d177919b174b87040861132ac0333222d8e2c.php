                ...
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="label-success">
                            <a href="<?php echo e(URL::to('/employee')); ?>">All Employee</a>
                        </li>
                        <li>
                            Route Search
                        </li>
    ...
    //====================Load JSON Search Record===============
     ...
     function loadSearchRecord() {
       ...
       if(route_id==""){
           ...
           $.ajax({
               type: "GET",
               url: "<?php echo e(URL::to('/')); ?>/json/get/employee/route",
               data: {
                   route_id: route_id
               },
               cache: false,
     ...
     $('#routeTable').on('click', '#delete_id', function () {
         ...
         if(x=='1'){
             $.ajax({
                 type: "GET",
                 url: "<?php echo e(URL::to('/')); ?>/json/delete/employee/route",
                 data: {
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/employee/routeSearch.blade.php ENDPATH**/ ?>