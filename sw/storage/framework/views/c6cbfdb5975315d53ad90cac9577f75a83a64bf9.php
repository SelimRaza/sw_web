                                ...
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="acmp_id" id="acmp_id"
                                            ...
                                            <?php $__currentLoopData = $acmps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $acmp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($acmp->id); ?>">
                                                    <?php echo e($acmp->acmp_code . '-' . $acmp->acmp_name); ?>
                                ...
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" id="lfcl_id" name="lfcl_id">
                                            ...
                                            <?php $__currentLoopData = $lfcl_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lfcl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($lfcl->id); ?>">
                                                    <?php echo e($lfcl->lfcl_name); ?>
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].status_id == 11 || data[i].status_id == 39) {
                            html += "<td><a target='_blank' href='<?php echo e(URL::to('/')); ?>/printer/salesInvoice_ou/" + data[i].cont_id + "/" + data[i].order_id + "/1"+"' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Sales Invoice Print </a></td>";
                        }
                        if(data[i].status_id==1){
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/Depot/OrderReport/order_summary.blade.php ENDPATH**/ ?>