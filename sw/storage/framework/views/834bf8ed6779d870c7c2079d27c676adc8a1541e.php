...
<?php $__env->startSection('content'); ?>
        ...
        <div class="">
            <div class="page-title">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <?php if($permission->wsmu_crat): ?>
                            <li class="label-success">
                                <a href="<?php echo e(URL::to('/outofstock/create')); ?>">Add New Item</a>
                            </li>
                        <?php endif; ?>
                    </ol>
                </div>
                <div class="title_right">
                    <?php if($permission->wsmu_crat): ?>
                        <a href="<?php echo e(URL::to('/bulk/outofstock')); ?>" style="color:darkred;font-weight:bold;" target="_blank"><i class="fa fa-upload"></i> Upload</a>
                    <?php endif; ?>
                </div>
            </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <select class="form-control select2" name="dpot_id" id="dpot_id">
                                                        ...
                                                        <?php $__currentLoopData = $dpot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dpt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($dpt->id); ?>"><?php echo e($dpt->dpot_code); ?>

                                                                - <?php echo e($dpt->dpot_name); ?></option>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <select class="form-control select2" name="itcg_id" id="itcg_id" onchange="getSubCategory(this.value)">
                                                        <option value="">Select</option>
                                                        <?php $__currentLoopData = $itcg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($cg->id); ?>"><?php echo e($cg->itcg_code); ?>

                                                                - <?php echo e($cg->itcg_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <select class="form-control select2" name="itcl_id" id="itcl_id">
                                                        <option value="">Select</option>
                                                        <?php $__currentLoopData = $itcl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($cls->id); ?>"><?php echo e($cls->itcl_code); ?>

                                                                - <?php echo e($cls->itcl_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        $("#delete-out-of-stock").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/bulk-delete/outofstock",
                data: {
                    _token:_token,
        ...
        function getSubCategory(itcl_id) {
            $.ajax({
                type: "GET",
                url: "<?php echo e(URL::to('/')); ?>/get/sub-category/"+itcl_id,
                cache: false,
                dataType: "json",
                success: function (data) {
        ...
        function getOutOfStockItem(){
            ...
            $.ajax({
                type:"POST",
                url:"<?php echo e(URL::to('/')); ?>/get/outofStock/items",
                data:{
                    dpot_id:dpot_id,
                    itcg_id:itcg_id,
                    itsg_id:itsg_id,
        ...
        function removeItem(v) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(URL::to('/')); ?>/remove/outofstock/item/"+id,
                cache: false,
                dataType: "json",
                success: function (data) {
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/outofstock/index.blade.php ENDPATH**/ ?>