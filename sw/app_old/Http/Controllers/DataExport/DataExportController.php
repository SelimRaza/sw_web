...
use App\DataExport\GroupZoneWiseOrderSummaryReportData;
...
use App\DataExport\NewlyOpenedOutletData;
...
class DataExportController extends Controller
{
    ...
    public function dataExportNonProductiveSRListData(Request $request)
    {
        ...
        if ($this->userMenu->wsmu_crat) {
            return Excel::download(NonProductiveSRListData::create($request->start_date, $request->end_date, $request->slgp_id), 'NonProductiveSRList_data_' . date("Y-m-d H:i:s") . '.xlsx');
    ...
    public function dataExportGroupZoneWiseOrderSummaryData(Request $request)
    {
        if ($this->userMenu->wsmu_crat) {
            return Excel::download(GroupZoneWiseOrderSummaryReportData::create($request->start_date, $request->end_date, $request->slgp_id, $request->zone_id), 'GroupZoneWiseOrderSummaryReport_data_' . date("Y-m-d H:i:s") . '.xlsx');
...
FROM tm_zone ");
    ...
    public function dataExportNewlyOpendedOutlet(Request $request)
    {
        $request->validate([
            'acmp_id'            => 'required',
            'slgp_id'            => 'required'
        ...
        if ($this->userMenu->wsmu_crat) {
            return Excel::download(NewlyOpenedOutletData::create($request->start_date, $request->end_date, $request->acmp_id,$request->slgp_id), 'outlet_count_data' . date("Y-m-d H:i:s") . '.xlsx');
