...
class BaseMasterUploadController extends Controller
{
    private $access_key = 'tbld_BaseUploadController_format';
    private $currentUser;
    private $userMenu;
    ...
    public function baseMasterUpload()
    {
        if ($this->userMenu->wsmu_crat) {
            return view('master_data.upload.base_master_upload')->with('permission', $this->userMenu);
        } else {
            return redirect()->back()->with('danger', 'Access Limited');
        }
    }
