...
class GroupSKUMappingUploadController extends Controller
{
    private $access_key = 'tbld_GroupSKUMappingUploadController_format';
    private $currentUser;
    private $userMenu;
    ...
    public function groupSkuMappingUpload()
    {
        if ($this->userMenu->wsmu_crat) {
            return view('master_data.upload.group_sku_mapping_upload')->with('permission', $this->userMenu);
        } else {
            return redirect()->back()->with('danger', 'Access Limited');
        }
    }
