...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($this->userMenu->wsmu_vsbl) {
           ...
           //$companies= DB::connection($this->db)->select("SELECT t1.* FROM `tm_acmp` t1 INNER JOIN user_group_permission t2 ON t1.id=t2.acmp_id WHERE t2.aemp_id='$emp_id' AND t1.cont_id='$country_id' group by t1.id");
