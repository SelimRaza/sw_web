...
UNION ALL
  ...
  'Outlet'                                AS type_name
FROM tm_site AS t1
WHERE (t1.site_code LIKE '%$search_text%' OR t1.site_name LIKE '%$search_text%' OR t1.site_mob1 LIKE '%$search_text%') $where2
UNION ALL
SELECT
  t1.id                                   AS trn_id,
...
FROM tm_locd AS t1
WHERE (t1.locd_code LIKE '%$search_text%' OR t1.locd_name LIKE '%$search_text%') $where3";
