...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <form id="demo-form2" data-parsley-validate
                              ...
                              action="<?php echo e(URL::to('grv_report/pushToRoutePlan')); ?>" enctype="multipart/form-data"
                              method="post">
    ...
    <script type="text/javascript">
        ...
        function filterData() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/grv_report/filterGRVSummary",
                data: {
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += "<td><a target='_blank' href='<?php echo e(URL::to('/')); ?>/printer/return/" + data[i].cont_id + "/" + data[i].order_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Return Print </a></td>";

                        if (data[i].status_id == 11) {
                            html += "<td><a target='_blank' href='<?php echo e(URL::to('/')); ?>/printer/returnInvoice/" + data[i].cont_id + "/" + data[i].order_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Return Invoice Print </a></td>";
                        }
                        html += '</tr>';
                        count++;
                    }
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsolutio/public_html/saleswheel/resources/views/Depot/GRVReport/grv_summary.blade.php ENDPATH**/ ?>