...
<?php if($pt_show==1): ?>
    <div class="col-md-12 col-sm-12 col-xs-12 " style="background-color:#fff; margin-top:-10px;">
        <div class="">
          <div class="">
            <?php if($parent_emp): ?>
            <h4 ><?php echo e($pt_show==1?$parent_emp[0]->role_name."-".$parent_emp[0]->aemp_name."-".$parent_emp[0]->aemp_usnm:''); ?><small></small></h4>
            <?php endif; ?>
          </div>
        </div>
    </div>
<?php endif; ?>
    ...
    <div class="row tile_count">
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" >
        ...
        <?php if($employee): ?>
        <div class="count" onclick="loadUnderEmployee()" style="cursor:pointer;"><?php echo e($employee[0]->totalSr); ?></div>
        <span class="count_bottom">
        <i class="fa fa-sort-asc">
          <i class="red" data-toggle="modal" data-target="#myModalOffSr" style="cursor:pointer;" onclick="getOffSRList()">Off:<?php echo e($employee[0]->offSr?$employee[0]->offSr:0); ?></i>
        ...
        <?php else: ?>
        <div class="count" onclick="loadUnderEmployee()" style="cursor:pointer;">0</div>
        <span class="count_bottom">
        <i class="fa fa-sort-asc">
          <i class="red">Off:0</i>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" id="outletDiv">
        <span class="count_top"><i class="glyphicon glyphicon-list-alt"></i>  Route Outlet</span>
        <?php if($employee): ?>
        <?php if($emp_role==2): ?>
        <div  style="text-size:15px; font-style:bold;">
          <span  class="count"><?php echo e($employee?$employee[0]->totalScheduleCall:0); ?></span>out of:
          <span style="font-size:16px; font-weight:bold;"><?php echo e($today_open_out?round($today_open_out[0]->opened_outlet_today/6):0); ?>

          <sub><?php echo e($today_open_out?$today_open_out[0]->opened_outlet_today:0); ?></sub></span>
        </div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="">W:<?php echo e($out_type_count[0]->Whole_Sale_site?$out_type_count[0]->Whole_Sale_site:0); ?></i>
            <i class="">|T:<?php echo e($out_type_count[0]->Tong_site?$out_type_count[0]->Tong_site:0); ?></i>
            <i class="">|GT:<?php echo e($out_type_count[0]->Trade_M_site?$out_type_count[0]->Trade_M_site:0); ?></i>
          </i>
        </span>
        ...
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="red">V:<?php echo e($employee[0]->total_visited?$employee[0]->total_visited:0); ?></i>
            <i class="green">|S:<?php echo e($employee[0]->productiveMemo?$employee[0]->productiveMemo:0); ?></i>
            <i class="gray">|PE/Olt:<?php echo e($employee[0]->APEOIT?$employee[0]->APEOIT:0); ?></i>
          </i>
        </span>
        <?php endif; ?>
        <?php else: ?>
      ...
      <?php if($emp_role==2): ?>
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" id="">
      <span class="count_top"><i class="glyphicon glyphicon-list-alt"></i> Visited</span>
      <?php if($employee): ?>
      <div class="count"><a href="#" data-toggle="modal" data-target="#myModalVisit" style="cursor:pointer;"  onclick="getCatWiseOutVisit()"><?php echo e($employee[0]->total_visited?$employee[0]->total_visited:0); ?></a></div>
      <span class="count_bottom">
        <i class="fa fa-sort-asc">
          <i class="">S:<?php echo e($employee[0]->productiveMemo?$employee[0]->productiveMemo:0); ?></i>
          <i class=""> |PE/OLT:<?php echo e($employee[0]->APEOIT?$employee[0]->APEOIT:0); ?></i>
        </i>
      </span>
      <?php else: ?>
      <div class="count">0</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        <span class="count_top"><i class="glyphicon glyphicon-tag"></i>  Strike Rate</span>
        <?php if($employee): ?>
          <?php
            if($employee[0]->total_visited !=0){
        ...
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="green">-Ve.:<?php echo e($employee[0]->nonProductiveSr?$employee[0]->nonProductiveSr:0); ?></i>
          </i> 
        </span>
        <?php else: ?>
        <div class="count">0%</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        <?php if($emp_role==2): ?>
        <span class="count_top"><i class="glyphicon glyphicon-list-alt"></i> Non visited</span>
        <?php else: ?>
        <span class="count_top"><i class="glyphicon glyphicon-list-alt"></i>  LPC</span>
        <?php endif; ?>
        ...
        <?php if($emp_role==2): ?>
            ...
            if($visited){
              $month1=$out-($visited[0]->onemonth);
              $month2=$out-($visited[0]->twomonth);
              $month3=$out-($visited[0]->threemonth);
            }else{
              $month1=$out;
              $month2=$out;
              $month3=$out;
        ...
        <div class="nonvisited">
          <p style="margin: 0 0 -6px;">L1M:<span  style="font-size:20px; font-weight:bold;"><?php echo e($month1); ?></span></p>
          <p style="margin: 0 0 -6px;">L2M:<span style="font-size:20px; font-weight:bold;"><?php echo e($month2); ?></span></p>
          <p style="margin: 0 0 -6px;">L3M:<span style="font-size:20px; font-weight:bold;"><?php echo e($month3); ?></span></p>
        </div>
        ...
        <?php else: ?>
        <div class="count"><?php echo e($employee?(number_format($employee[0]->lineParCall,2)):0); ?></div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        <span class="count_top"><i class="glyphicon glyphicon-list-alt"></i> Todays Order</span>
        <?php if($employee): ?>
        <div class="count"><?php echo e($employee?(number_format($employee[0]->totalOrderAmount,2)):0); ?></div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="">Today Tgt:<?php echo e($employee[0]->totalTargetAmount?(number_format($employee[0]->totalTargetAmount/26,2)):0); ?></i>
          </i> 
        </span>
        <?php else: ?>
        <div class="count">0</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" id="contributionDiv">
        <span class="count_top"><i class="glyphicon glyphicon-list-alt"></i>  Contribution</span>
        <?php if($employee): ?>
        <div class="count"><?php echo e($employee?(number_format($employee[0]->totalOrderAmount/($employee[0]->actSr?$employee[0]->actSr:1),2)):0); ?></div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="">A.Olt/SR:<?php echo e($employee[0]->totalScheduleCall?(number_format($employee[0]->totalScheduleCall/($employee[0]->onSr?$employee[0]->onSr:1),2)):0); ?></i>
            <i class="">A.V/SR:<?php echo e($employee[0]->total_visited?(number_format($employee[0]->total_visited/($employee[0]->onSr?$employee[0]->onSr:1),2)):0); ?></i>
          </i>
        </span>
        <?php else: ?>
        <div class="count">0</div>
    ...
    <!-- /top tiles -->
 <!-- barchart for target vs achievement  start here -->
 <?php if($pillar_data): ?>
  <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12 ">
          <div class="x_panel">
            <div class="x_title">
              <h2>Class wise Target vs Achievement(Pillar)<small></small></h2>
            ...
            <div class="x_content">
              <div id="tgt_vs_achv_bar" style="width:100%; height:300px;"></div>
            </div>
          </div>
      </div>
  </div>
 ...
 <!-- barchart for target vs achievement  end here -->
  ...
  <?php if($employee): ?>
            ...
            <div class="widget_summary">
              ...
              <div class="w_center pg_bar_percen">
                <div class="progress">
                  ...
                  <div class="progress-bar bg-forestgreen" role="progressbar" aria-valuenow="60"
            ...
            <table class="" style="width:100%">
              ...
              <tr>
                ...
                <td>
                  ...
                  <tr>
                      <td>
                        <p><i class="fa fa-square" style="color:#1ABB9C"></i>Positive</p>
                      </td>
                      <td><?php echo e($employee?(number_format(($employee[0]->pvSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0); ?>%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#F5F75A"></i>Negative</p>
                    </td>
                    <td><?php echo e($employee?(number_format(($employee[0]->nveSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0); ?>%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:lightgreen"></i>Inactive</p>
                    </td>
                    <td><?php echo e($employee?(number_format(($employee[0]->inactSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0); ?>%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#F9522D"></i>Off </p>
                    </td>
                    <td><?php echo e($employee?(number_format(($employee[0]->offSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0); ?>%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#A9A9A9"></i>Leave</p>
                    </td>
                    <td><?php echo e($employee?(number_format(($employee[0]->levSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0); ?>%</td>
                  </tr>
                  </table>
                </td>
              </tr>
        ...
        <div class="x_panel tile fixed_height_320 overflow_hidden">
          ...
          <div class="x_content">
            <table class="" style="width:100%">
              ...
              <tr>
                <td>
                  <canvas class="canvasDoughnut2" height="140" width="140"
                          style="margin: 15px 10px 10px 0"></canvas>
                </td>
                <td>
                  <table class="tile_info">
                  <tr>
                      <td>
                        <p><i class="fa fa-square" style="color:#35A236"></i>Productive</p>
                      </td>
                      <td><?php echo e($employee?(number_format(($employee[0]->pvSr*100/($employee[0]->onSr==0?1:$employee[0]->onSr)),2)):0); ?>%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#F9522D"></i>Non-P. </p>
                    </td>
                    <td><?php echo e($employee?(number_format(($employee[0]->nonProductiveSr*100/($employee[0]->onSr==0?1:$employee[0]->onSr)),2)):0); ?>%</td>
            ...
            <table class="" style="width:100%">
              ...
              <tr>
                ...
                <td>
                  ...
                  <tr>
                      <td>
                        <p><i class="fa fa-square" style="color:#006A4E"></i>Positive</p>
                      </td>
                      <td>30%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:green"></i>Negative</p>
                    </td>
                    <td>30%</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#8B0000"></i>Off </p>
                    </td>
                    <td>10%</td>
                  </tr>
                  <tr>
            ...
            <table class="" style="width:100%">
              ...
              <tr>
                ...
                <td>
                  ...
                  <tr>
                      <td>
                        <p><i class="fa fa-square" style="color:#006A4E"></i>Productive</p>
                      </td>
                      <td><?php echo e($employee?(number_format(($employee[0]->pvSr*100/($employee[0]->onSr==0?1:$employee[0]->onSr)),2)):0); ?>%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#8B0000"></i>Non-P. </p>
                    </td>
                    <td><?php echo e($employee?(number_format(($employee[0]->nonProductiveSr*100/($employee[0]->onSr==0?1:$employee[0]->onSr)),2)):0); ?>%</td>
    ...
    <!-- <div class="row">
      ...
      <div class="col-md-7 col-sm-7 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Visit vs Memo<small></small></h2>
              <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                </li>
                <li class="dropdown">
  ...
  $.ajax({
    ...
    success: function (data){
      ...
      for(var i=0;i<data.length;i++){
        ...
        '<td>'+data[i]['aemp_mob1']+'</td></tr>';
        count++;
      }
      if(data.length==0){
        html+="<tr><td>Off SR List Will be shown Between HOS and TSM Level</td></tr>"
      }
  ...
  $.ajax({
    ...
    success: function (data){
      ...
      for(var i=0;i<data.length;i++){
        ...
        '<td>'+data[i]['num']+'</td>'+
        '<td><i id="show" class="fa fa-info-circle fa-2x "  data-toggle="modal" data-target="#myModalVisitedOutlet" style="cursor:pointer; color:forestgreen;" onclick="getVisitedOutletDetails('+emid+','+data[i]['id']+')"></i></td>'+
        '</tr>';
      }
...
function getVisitedOutletDetails(emid,cat_id){
  ...
  $.ajax({
        type:"get",
        url:"<?php echo e(URL::to('/')); ?>/getVisitedOutletDetailsDashboard/"+emid+"/"+cat_id,
        dataType: "json",
        success: function (data){
...
<?php echo $__env->make('theme.app_all', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsolutio/public_html/saleswheel/resources/views/project_board.blade.php ENDPATH**/ ?>