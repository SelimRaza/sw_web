    ...
    <div class="right_col" role="main">
            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>District Employee</strong>
                        </li>
                        <?php if($permission->wsmu_crat): ?>
                            <li class="label-success">
                                <a href="<?php echo e(URL::to('/district/sr/mapping/format')); ?>">District Employee
                                    Format</a>
                            </li>
                        <?php endif; ?>
                    </ol>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <form id="demo-form2" data-parsley-validate
                                              ...
                                              action="<?php echo e(URL::to('district/sr/mapping/store')); ?>"
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h3>SR District Mapping Data Export</h3>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </li>
                            <li class="dropdown">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                              action="<?php echo e(URL::to('/district/sr/mapping/data/export')); ?>"
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left"
                              action="<?php echo e(URL::to('district/sr/mapping')); ?>"
                              method="post" enctype="multipart/form-data">
                            <input type="hidden" name="_token" id="_token" value="<?php echo csrf_token(); ?>">
                            <?php echo e(csrf_field()); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">District Code
                                        </label>
                                        <div class="col-md-5 col-sm-5 col-xs-12">
                                            <input id="than_code" name="than_code" class="form-control col-md-7 col-xs-12" placeholder="Enter District Code">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h3>SR District Mapping Delete</h3>
                        <ul class="nav navbar-right panel_toolbox">
                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                            </li>
                            <li class="dropdown">
    ...
    <script type="text/javascript">
        ...
        function getUserThana(){
          ...
          if(staff_code==""){
            ...
            var url = "<?php echo e(url('/district/sr/mapping/data/view')); ?>/"+staff_code;
        ...
        function deleteSRFromThana(id){
          ...
          if(x){
             ...
             $.ajax({
                ...
                type: "GET",
                url: "<?php echo e(url('district/sr/mapping/data/delete')); ?>/"+id,
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/Depot/Depot/districtsr_mapping.blade.php ENDPATH**/ ?>