                    ...
                    <ol class="breadcrumb">
                        ...
                        <?php if($permission->wsmu_crat): ?>
                            <li class="label-success">
                                <a href="<?php echo e(URL::to('/category/create')); ?>">New Category</a>
                            </li>
                        <?php endif; ?>
                    </ol>
                </div>
                            ...
                            <table class="table table-striped projects">
                                ...
                                <?php $__currentLoopData = $categorys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($category->itcg_name); ?></td>
                                        <td><?php echo e($category->itcg_code); ?></td>
                                            ...
                                            <?php if($permission->wsmu_delt): ?>
                                                <form style="display:inline"
                                                    ...
                                                    <input class="btn btn-danger btn-xs" type="submit"
                                                           value="<?php echo $category->lfcl_id == 1 ? 'Active' : 'Inactive'?>"
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsolutio/public_html/saleswheel/resources/views/master_data/category/index.blade.php ENDPATH**/ ?>