                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <select class="form-control select2" name="dsct_id" id="dsct_id"
                                                        ...
                                                        <?php $__currentLoopData = $dist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($dst->id); ?>"><?php echo e($dst->dsct_code); ?>

                                                                - <?php echo e($dst->dsct_name); ?></option>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <select class="form-control select2" name="otcg_id" id="otcg_id">
                                                        <option value="">Select</option>
                                                        <?php $__currentLoopData = $otcg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($otg->id); ?>"><?php echo e($otg->otcg_code); ?>

                                                                - <?php echo e($otg->otcg_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 col-sm-4 col-xs-6">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <select class="form-control select2" name="chnl_id" id="chnl_id" onchange="getSubChannel(this.value)">
                                                        <option value="">Select</option>
                                                        <?php $__currentLoopData = $chnl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cnl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($cnl->id); ?>"><?php echo e($cnl->chnl_code); ?>

                                                                - <?php echo e($cnl->chnl_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function getSubChannel(id){
            if(id !=''){
                $.ajax({
                    type:"GET",
                    url:"<?php echo e(URL::to('/')); ?>/getSubChannel/"+id,
                    success:function(data){
                        $('#ajax_load').hide();
        ...
        function getOutletMaster(){
            ...
            $.ajax({
                type:"POST",
                url:"<?php echo e(URL::to('/')); ?>/site/getOutletMaster",
                data:{
                    dsct_id:dsct_id,
                    than_id:than_id,
                    otcg_id:otcg_id,
                ...
                success:function(data){       
                    ...
                    for(let i=0;i<site.length;i++){
                        ...
                        if(permission.wsmu_delt){
                            html+= '<form style="display:inline" action="site/lfcl_change/' + site[i].site_id + '" class="pull-xs-right5 card-link" method="POST"><?php echo e(csrf_field()); ?><?php echo e(method_field("DELETE")); ?><input class="btn btn-danger btn-xs" type="submit" value="'+site[i].lfcl_name+'" onclick="return ConfirmReset()"></input></form></td></tr>';
                        }                            
                        count++;                                
                    }
                    $('#cont').empty();
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsolutio/public_html/saleswheel/resources/views/master_data/site/outlet/index.blade.php ENDPATH**/ ?>