...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control cmn_select2" name="acmp_id" id="acmp_id"
                                        ...
                                        <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $companies1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($companies1->id); ?>"><?php echo e(ucfirst($companies1->acmp_name)."(".$companies1->acmp_code.")"); ?></option>
                            ...
                            <div class="form-group col-md-6 gvt">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control cmn_select2" name="otcg_id" id="otcg_id"
                                        ...
                                        <?php $__currentLoopData = $otcg_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otcg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($otcg->id); ?>"><?php echo e(ucfirst($otcg->otcg_name)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group col-md-6 gvt">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control cmn_select2" name="chnl_id" id="chnl_id"
                                        ...
                                        <?php $__currentLoopData = $channel_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chnl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($chnl->id); ?>"><?php echo e(ucfirst($chnl->chnl_code)."(".$chnl->chnl_name.")"); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <?php if($permission->wsmu_crat): ?>
                                <a class="btn btn-success btn-sm" href="<?php echo e(URL::to('/companySiteMapping/create')); ?>">Setup Company
                                    Site mapping</a>
                            <?php endif; ?>
                            <h1>Company Site Mapping</h1>
    ...
    <script type="text/javascript">
        ...
        function filterData() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/companySiteMapping/filter",
                data: {
                    site_code: site_code,
                    acmp_id: acmp_id,
                    slgp_id: slgp_id,
                ...
                success: function (data) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        html += "<td><a  href='<?php echo e(URL::to('/')); ?>/site/credit-adjust/" + data[i].site_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i>Adjust</a></td></tr>";
        ...
        function getSubchannel(chnl_id) {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo e(URL::to('/')); ?>/getSubChannel/"+chnl_id,
                cache: false,
                dataType: "json",
                success: function (data) {
                    $('#ajax_load').css("display", "none");
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/CompanySiteMapping/index.blade.php ENDPATH**/ ?>