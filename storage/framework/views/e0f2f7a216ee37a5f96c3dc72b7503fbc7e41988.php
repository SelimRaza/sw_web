    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                ...
                <form action="<?php echo e(URL::to('/district')); ?>" method="get">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <?php if($permission->wsmu_crat): ?>
                                <a class="btn btn-success btn-sm" href="<?php echo e(URL::to('/district/create')); ?>"><span
                                            class="fa fa-plus-circle" style="color: white; font-size: 1.3em"></span>&nbsp;&nbsp;<b>Add
                                        New</b></a>

                                <button class="btn btn-danger btn-sm" onclick="exportTableToCSV('region_master<?php echo date('Y_m_d'); ?>.csv','datatable')"
                        ...
                        <div class="x_content">
                            <?php echo e($districts->appends(Request::only('search_text'))->links()); ?>
                            ...
                            <table id="datatable" class="table font_color" data-page-length='50'>
                                ...
                                <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="tbl_body_gray">
                                        ...
                                        <td><?php echo e($district->dsct_name); ?></td>
                                        <td><?php echo e($district->dsct_code); ?></td>
                                        <td><?php echo e($district->division()->disn_name); ?></td>
                                        <td>
                                            <?php if($permission->wsmu_delt): ?>
                                                <form style="display:inline"
                                                      action="<?php echo e(route('district.destroy',$district->id)); ?>"
                                                    ...
                                                    <input class="btn btn-round btn-xs"
                                                           style="color:white; background-color: <?php echo $district->lfcl_id == 1 ? '#06993a' : '#9f0e35'?>"
                                                           type="submit"
                                                           value="<?php echo $district->lfcl_id == 1 ? 'Active' : 'Inactive'?>"
                                                           onclick="return ConfirmDelete()">
                                                    </input>
                                                </form>
                                            <?php else: ?>
                                                <span class="badge"
                                                      style="background-color: <?php echo $district->lfcl_id == 1 ? '#06993a' : '#9f0e35'?>"><?php echo $district->lfcl_id == 1 ? 'Active' : 'Inactive'?></span>
                                            <?php endif; ?>
                                        ...
                                        <td>
                                            <?php if($permission->wsmu_read): ?>
                                                <a href="<?php echo e(route('district.show',$district->id)); ?>"
                                                   class="btn btn-primary btn-xs"><i class="fa fa-search"></i> View
                                                </a>&nbsp;|&nbsp;
                                            <?php endif; ?>
                                            <?php if($permission->wsmu_updt): ?>
                                                <a href="<?php echo e(route('district.edit',$district->id)); ?>"
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/district/index.blade.php ENDPATH**/ ?>