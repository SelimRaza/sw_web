                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left"
                                  action="<?php echo e(url ('load/filter/common_sr_activity_filter/demo2')); ?>"
                                                ...
                                                <div class="col-md-10 col-sm-10 col-xs-12" id="user_level"
                                                    ...
                                                    <div>
                                                        <div id='emid_div' style="display:none;">
                                                            <input type="hidden" value="<?php echo e($emid); ?>" id="emid">
                                                        </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <select class="form-control commonSelect2" name="depo_id"
                                                            ...
                                                            <?php $__currentLoopData = $depo_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($depo->dlrm_code); ?>"><?php echo e($depo->dlrm_code); ?>

                                                                    - <?php echo e($depo->dlrm_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group col-md-6 gvt">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <select class="form-control commonSelect2" name="dist_id"
                                                            ...
                                                            <?php $__currentLoopData = $dsct1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($d->id); ?>"><?php echo e($d->dsct_name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="form-group col-md-6 " id="asset_div" style="display:none;">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <select class="form-control commonSelect2" name="astm_id"
                                                            ...
                                                            <?php $__currentLoopData = $asset; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ast): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($ast->id); ?>"><?php echo e($ast->astm_name); ?>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <p class="modal-title text-center">
                        Productive Visit:<img src="<?php echo e(asset('theme/image/map_icon_all/pv.png')); ?>">&nbsp;&nbsp;&nbsp;&nbsp;
                        ||&nbsp;&nbsp;&nbsp;&nbsp;Non.Productive Visit:<img src="<?php echo e(asset('theme/image/map_icon_all/npv.png')); ?>">
                        Non Visited:<img src="<?php echo e(asset('theme/image/map_icon_all/nv.png')); ?>">&nbsp;&nbsp;&nbsp;&nbsp;
                        ||&nbsp;&nbsp;&nbsp;&nbsp;SR Location: <img src="<?php echo e(asset('theme/image/map_icon_all/point.png')); ?>">
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        ||&nbsp;&nbsp;&nbsp;&nbsp;Start: <img src="<?php echo e(asset('theme/image/map_icon_all/start.png')); ?>">
                        ||&nbsp;&nbsp;&nbsp;&nbsp;End: <img src="<?php echo e(asset('theme/image/map_icon_all/end.png')); ?>">
                    </p>
        ...
        <div class="modal-dialog modal-lg" style="width:90%;margin-top:-220px;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <p class="modal-title text-center">
                        Start Location:<img src="<?php echo e(asset('theme/image/map_icon/pv.png')); ?>">&nbsp;&nbsp;&nbsp;&nbsp;
                        ||&nbsp;&nbsp;&nbsp;&nbsp;Ending Location:<img src="<?php echo e(asset('theme/image/map_icon/npv.png')); ?>">
    ...
    <div class="modal fade" id="note_type" role="dialog">
        ...
        <script type="text/javascript">
            ...
            function getZone() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/load/report/getZone_adv",
                    data: {
                        dirg_id: dirg_id,
                        _token: _token
                    },
            ...
            function getSRForWeeklyOrder() {
                ...
                if(rpt_type=='weekly_outlet_summary'){
                   // $('#ajax_load').css("display", "block");
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(URL::to('/')); ?>/report/getSRListModuleTwo_adv",
                        data: {
            ...
            function getSR(id, type) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/report/getSRListofActivityReport",
                    data: {
                        slgp_id: slgp_id,
                        dist_id: dist_id,
                        than_id: than_id,
            ...
            function loadOutlet(market_id, place) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/json/get/market-wise/outlet",
                    data: {
                        market_id: market_id,
                        _token: _token
                    },
            ...
            function getAllTrip() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/load_trip",
                    data: {
                        trip_date: trip_date,
                        depo_id: depo_id,
                        _token: _token
            ...
            function getDiggingReport(emp_tracking_hierarchy) {
                ...
                if (emp_tracking_hierarchy == 'emp_tracking_sales_hierarchy') {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(URL::to('/')); ?>/getTrackingRecord",
                        cache: false,
                        dataType: "json",
                        success: function (data) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "<?php echo e(URL::to('/')); ?>/getGvtTrackingRecord",
                        data:{
                            slgp_id:slgp_id,
                            acmp_id:acmp_id,
            ...
            function getTripData(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/print/trip_data",
                    data: {
            ...
            function getAccountsData(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/getAccountsData",
                    data: {
                        _token: _token,
                        reportType: reportType,
                        year_mnth:year_mnth,
                            ...
                            case "special_budget":
                                if(budget_details_sum==1){
                                    ...
                                    for(var i=0;i<data.length;i++){
                                        ...
                                        html += "<td><a target='_blank' href='<?php echo e(URL::to('/')); ?>/special_budget/details/" + data[i].spbm_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i>Details </a></tr>";
                                        count++;
                                    }
                                }
                                else{
                                ...
                                if(budget_details_sum==1){
                                    ...
                                    for(var i=0;i<data.length;i++){
                                        html += '<tr>' +
                                                ...
                                                '<td>' + data[i]['spbm_avil'] + '</td>' +
                                                '<td>' + data[i]['spbm_amnt'] + '</td>';
                                        html += "<td><a target='_blank' href='<?php echo e(URL::to('/')); ?>/credit_budget/details/" + data[i].id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i>Details </a></tr>";
                                        count++;
                                    }
                                }
                                else{
            ...
            function getSummaryReport() {
                ...
                if (validityCheck != false) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(URL::to('/')); ?>/getSummaryData",
                            data: {
                                reportType: reportType,
                                acmp_id: acmp_id,
                                zone_id: zone_id,
        ...
        <script id="deviation_rpt_script">
            function getDeviationData(reportType) {
                ...
                if (reportType == 'group_wise_route_outlet') {
                    ...
                    $.ajax({
                        type: "get",
                        url: "<?php echo e(URL::to('/')); ?>/getDeviationData",
                        success: function (data) {
                            $('#ajax_load').css("display", "none");
                            console.log(data);
                            $('#tableDiv_traking_gvt').show();
                ...
                if (reportType == 'outlet_visit') {
                    ...
                    $.ajax({
                        type: "get",
                        url: "<?php echo e(URL::to('/')); ?>/getDeviationData/outletVisit/" + stage,
                        success: function (data) {
                            $('#ajax_load').css("display", "none");
                            $('#tableDiv_traking_gvt').show();
                            $('#tableDiv_tracking_gvt_header1').empty();
                ...
                if (reportType == 'note_task') {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo e(URL::to('/')); ?>/getNoteTaskReport",
                        cache: false,
                        dataType: "json",
                        success: function (data) {
                            $('#ajax_load').css("display", "none");
                ...
                if (reportType == 'sr_movement') {
                    ...
                    $.ajax({
                        type: "get",
                        url: "<?php echo e(URL::to('/')); ?>/getSrMovementSummary",
                        success: function (data) {
                            $('#ajax_load').css("display", "none");
                            console.log(data);
                            $('#tableDiv_traking_gvt').show();
            ...
            function getDeviationDeeperData(v) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/getDeviationDeeperData",
                    data: {
                        _token: _token,
                        id: id,
                        date: date,
            ...
            function getDateWiseDeviationData(date, rpt) {
                ...
                //     $.ajax({
                //         type:"POST",
                //         url:"<?php echo e(URL::to('/')); ?>/getDeviationDeeperData/"+stage,
                //         data:{
                //             _token:_token,
                //             id:id,
                //             date:date,
            ...
            function devNoteTaskClickAppend(v) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/getUserAndDateWiseTaskNote",
                    data: {
                        _token: _token,
                        emid: emid,
                        date: date
            ...
            function getSrMovementSummaryDeeparData(v) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/getSrMovementSummaryDeeparData",
                    data: {
                        _token: _token,
                        id: id,
                        stage: stage,
            ...
            function showWardWiseVisitDetails(v) {
                ...
                $.ajax({
                    type: "get",
                    url: "<?php echo e(URL::to('/')); ?>/getWardWiseVisitDetails/" + emp_id + "/" + date,
                    dataType: "json",
                    success: function (data) {
            ...
            function showWardWiseVisitOutletDetails(v, type, stage) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(URL::to('/')); ?>/showWardWiseVisitOutletDetails/",
                    data: {
                        id: id,
                        date: date,
                        type: type,
            ...
            function showCatWiseOutlet(v, cat_id) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(URL::to('/')); ?>/showCatWiseOutlet/",
                    data: {
                        id: id,
                        date: date,
                        cat_id: cat_id,
            ...
            function showAllVisitedOutletList(v) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo e(URL::to('/')); ?>/showAllVisitedOutletList/",
                    data: {
                        id: id,
                        date: date,
                        _token: _token,
            ...
            function reportRequestPlacement1() {
                ...
                if (validityCheck != false) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(URL::to('/')); ?>/commonReportRequest",
                        data: {
                            reportType: reportType,
                            acmp_id: acmp_id,
                            zone_id: zone_id,
            ...
            function getNoteImage(v){
                ...
                $.ajax({
                    type:"GET",
                    url:"<?php echo e(URL::to('/')); ?>/line/note/details/"+note_id,
                    dataType:"json",
                    success:function(data){
            ...
            function getSurveyImage(v){
                ...
                $.ajax({
                    type:"GET",
                    url:"<?php echo e(URL::to('/')); ?>/line/item_survey/details/"+note_id,
                    dataType:"json",
                    success:function(data){
...
<script src="<?php echo e(asset('theme/src/js/Advance/filter_date_control.js')); ?>"></script>
<script src="<?php echo e(asset('theme/src/js/Advance/c_sr_attendance_rpt.js')); ?>"></script>
<script src="<?php echo e(asset('theme/src/js/Advance/c_sr_activity_polyline_map.js')); ?>"></script>
<script src="<?php echo e(asset('theme/src/js/Advance/c_sr_sales_gvt_monitoring.js')); ?>"></script>
<!-- <script src="<?php echo e(asset('theme/src/js/Advance/date_control.js')); ?>"></script>
<script src="<?php echo e(asset('theme/src/js/Advance/c_filter_division_control.js')); ?>"></script> -->
<script src="<?php echo e(asset('theme/src/js/Advance/c_sr_note_report.js')); ?>"></script>
<script src="<?php echo e(asset('theme/src/js/Advance/asset_report.js')); ?>"></script>
<script src="<?php echo e(asset('theme/src/js/Advance/c_report_request.js')); ?>"></script>
<script>
$(document).ready(function(){
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsolutio/public_html/saleswheel/resources/views/report/Advance/common_report_adv.blade.php ENDPATH**/ ?>