    ...
    <script>
        ...
        function addCashCreditBudget(){
            ...
            if(aemp_usnm !='' && scbm_date !='' && type !='' && limit !=''){
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/add/cash_party/budget",
                    data:{
                        aemp_usnm:aemp_usnm,
                        scbm_date:scbm_date,
                        type:type,
        ...
        function checkCreditBudget(){
            ...
            if(aemp_usnm !='' && scbm_date !=''){
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(URL::to('/')); ?>/check/cash_party/budget/"+aemp_usnm+"/"+scbm_date,
                    cache: false,
                    dataType: "json",
                    success: function (data) {
                        $('#cont').empty();
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/blockOrder/CashCredit/create.blade.php ENDPATH**/ ?>