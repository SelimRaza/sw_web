            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo e(URL::to('/cash_party_credit_budget')); ?>"> Cash Party Credit Budget</a>
                        </li>
                        <li class="active">
                            ...
                            <table class="table table-striped projects">
                                ...
                                <?php $__currentLoopData = $specialBudgetLine; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $specialBudgetLine1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($specialBudgetLine1->scbd_amnt); ?></td>
                                        <td><?php echo e($specialBudgetLine1->scbd_type); ?></td>
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/blockOrder/CashCredit/show.blade.php ENDPATH**/ ?>