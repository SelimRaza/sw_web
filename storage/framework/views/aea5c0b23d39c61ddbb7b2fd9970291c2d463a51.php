...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="<?php echo e(route('pjp.store')); ?>"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select class="form-control select2" name="sales_group_id"
                                                ...
                                                <?php $__currentLoopData = $salesGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($salesGroup->id); ?>"><?php echo e(ucfirst($salesGroup->name)); ?></option>
    ...
    <script>
        ...
        function filterEmployee() {
            ...
            if (sales_group_id != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/employee/filterEmployeeByGroup",
                    data: {
    ...
    /*    function filterRoute() {
            ...
            if (sales_group_id != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/route/filterRoute",
                    data: {
                        sales_group_id: sales_group_id,
                        _token: _token
                    },
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/pjp/create.blade.php ENDPATH**/ ?>