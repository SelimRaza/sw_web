                                            ...
                                            <ul class="list-inline">
                                                <li>
                                                    <?php if($sku->amim_imgl): ?>
                                                        <img src="https://images.sihirbox.com/<?php echo e($sku->amim_imgl); ?>"
                                            ...
                                            <ul class="list-inline">
                                                <li>
                                                    <?php if($sku->amim_imic): ?>
                                                        <img src="https://images.sihirbox.com/<?php echo e($sku->amim_imic); ?>"
                                                             class="avatar" alt="Avatar">
                                                    <?php endif; ?>
                                                </li>
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsolutio/public_html/saleswheel/resources/views/master_data/sku/index.blade.php ENDPATH**/ ?>