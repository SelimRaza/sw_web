            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a class="label-success" href="<?php echo e(URL::to('/rpln-mapping')); ?>">All Rout Plan</a>
                        </li>
                        <li class="active">
                            <strong><?php echo e(ucwords($purpose) ?? ''); ?></strong>
                        </li>
                    </ol>
                </div>
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/Mapping/RoutePlan/route_like.blade.php ENDPATH**/ ?>