    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                ...
                <form action="<?php echo e(URL::to('/depot')); ?>" method="get">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <?php if($permission->wsmu_crat): ?>
                        <a href="<?php echo e(URL::to('/depot/create')); ?>" class="btn btn-success btn-sm">Add New</a>
                        <?php if($cont_id == '2' || $cont_id == '5'): ?>
                            <a href="<?php echo e(URL::to('/depot/upload/login')); ?>" class="btn btn-success btn-sm">Dealer Login Create</a>
                        <?php endif; ?>
                    <?php endif; ?>
                    <div class="x_panel">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <select class="form-control" name="dist_id" id="dist_id"
                                            ...
                                            <?php $__currentLoopData = $dsct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dsctList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($dsctList->id); ?>"><?php echo e($dsctList->dsct_code); ?>

                                                    - <?php echo e($dsctList->dsct_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function getReport() {
            ...
            if (slgp_id != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/depot/filter/DepotDetails",
                    data: {
                        acmp_id: acmp_id,
                        zone_id: zone_id,
                        dist_id: dist_id,
        ...
        function getDealerLogin(d_id) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/depot/create/dealer/login",
                data: {
                    id: d_id,
                    _token: _token
                },
        ...
        function getDealerPassReset(d_id) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/depot/create/dealer/passReset",
                data: {
                    id: d_id,
                    _token: _token
                },
        ...
        function changeDealerStatus(d_id) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/depot/dealer/statusChange",
                data: {
                    id: d_id,
                    _token: _token
                },
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/Depot/Depot/index.blade.php ENDPATH**/ ?>