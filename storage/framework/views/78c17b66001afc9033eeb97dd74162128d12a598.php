...
<?php $__env->startSection('content'); ?>
            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo e(URL::to('/site')); ?>"></i>Site</a>/
                        ...
                        <div class="x_content">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="erp_zone" id="erp_zone">
                                            ...
                                            <?php $__currentLoopData = $erpzn; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($zone->epzn_code); ?>"><?php echo e($zone->epzn_code); ?>

                                                - <?php echo e($zone->epzn_name); ?></option>
                            ...
                            <table id="datatable" class="table table-bordered projects" data-page-length='25'>
                                ...
                                <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $site): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><input type="checkbox" class="sub_chk" name="group" value="<?php echo e($site->id); ?>"></td>
                                        <td><?php echo e($index+1); ?></td>
                                        <td><input type="text" class="olt_code form-control" value="<?php echo e($site->site_code); ?>"> <p class="hidden"><?php echo e($site->site_code); ?></p></td>
                                        ...
                                        <td><img src="<?php echo e('https://sw-bucket.sgp1.cdn.digitaloceanspaces.com/'.$site->site_imge); ?>" height="90" width="150"  alt="N/A"></td>
    ...
    <script type="text/javascript">
        ...
        $("#inactiveSite").click(function(){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/site/unverified_inactive",
                data: {
                   sites:sites,
                   erp_zone:erp_zone,
                   _token:_token,
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/master_data/site/unverified.blade.php ENDPATH**/ ?>