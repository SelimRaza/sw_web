...
<?php $__env->startSection('content'); ?>
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control cmn_select2" name="aemp_id" id="aemp_id"
                                        ...
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($usr->id); ?>"><?php echo e('['.$usr->aemp_usnm.'] '.ucfirst($usr->aemp_name)); ?></option>
    ...
    <script type="text/javascript">
        ...
        function filterData() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/sr-group",
                data: {
                    aemp_id: aemp_id,
                    _token: _token
                },
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/Mapping/sr_group.blade.php ENDPATH**/ ?>