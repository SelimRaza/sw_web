...
<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript">
        ...
        function filterData() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/emp/attendance/report",
                data: {
        ...
        function getAttnDetailsRequest(){
            $.ajax({
                type:"Get",
                url: "<?php echo e(URL::to('/')); ?>/emp/attendance/details/request",
                cache: false,
                dataType: "json",
                success: function (data) {
                    console.log(data)
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bsolutio/public_html/saleswheel/resources/views/Attendance/Report/index.blade.php ENDPATH**/ ?>