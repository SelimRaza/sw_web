<?php $__env->startSection('content'); ?>
                                                ...
                                                <div class="form-group col-md-6 attendance_type_div"  id="attendance_type_div">
                                                    ...
                                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                                        <select class="form-control cmn_select2" name="edsg_id"
                                                                ...
                                                                <?php $__currentLoopData = $edsg_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $edsg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($edsg->id); ?>"><?php echo e($edsg->edsg_name); ?>
        ...
        <div class="modal-dialog modal-lg" style="width:80%;margin-top:-200px;">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <p class="modal-title text-center">
                        Start Location:<img src="<?php echo e(asset('theme/image/map_icon/start.png')); ?>">&nbsp;&nbsp;&nbsp;&nbsp;
                        ||&nbsp;&nbsp;&nbsp;&nbsp;Ending Location:<img src="<?php echo e(asset('theme/image/map_icon/end.png')); ?>">
    ...
    <script type="text/javascript">
        ...
        function getSRForWeeklyOrder() {
            ...
            if(rpt_type=='weekly_outlet_summary'){
               // $('#ajax_load').css("display", "block");
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(URL::to('/')); ?>/report/getSRListModuleTwo",
                    data: {
        ...
        function getSR(id, type) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo e(URL::to('/')); ?>/report/getSRList",
                data: {
                    slgp_id: slgp_id,
                    dist_id: dist_id,
                    than_id: than_id,
            ...
            if (validityCheck != false) {
                if (reportType == "sr_wise_item_summary_quatar"){
                    ///alert(reportType);
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo e(URL::to('/')); ?>/load/filter/common_sr_activity_filter/demo99",
                            data: {
                                acmp_id: acmp_id,
                                zone_id: zone_id,
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(URL::to('/')); ?>/load/filter/common_sr_activity_filter/orderDetails",
                        data: {
                            acmp_id: acmp_id,
                            zone_id: zone_id,
                            sales_group_id: sales_group_id,
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(URL::to('/')); ?>/load/filter/common_sr_activity_filter/demo2",
                        data: {
                            _token: _token,
...
<!--<?php $__env->startPush('styles'); ?>
    ...
    <script src="<?php echo e(asset('theme/src/js/c_report/c_sr_attendance_rpt.js')); ?>"></script>
    <!-- <script src="<?php echo e(asset('theme/src/js/c_report/c_sr_activity_map.js')); ?>"></script> -->
    <script src="<?php echo e(asset('theme/src/js/c_report/c_sr_activity_polyline_map.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/src/js/c_report/c_sr_sales_gvt_monitoring.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/src/js/c_report/date_control.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/src/js/c_report/c_filter_division_control.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/src/js/c_report/c_sr_note_report.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/src/js/c_report/asset_report.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/src/js/c_report/c_report_request.js')); ?>"></script>
    <script src="<?php echo e(asset('theme/src/js/c_report/c_note_summary_map.js')); ?>"></script>
    <!-- <script src="<?php echo e(asset('theme/src/js/jquery.doubleScroll.js')); ?>"></script> -->
    <script>
        $(document).ready(function(){
...
<?php echo $__env->make('theme.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/test/sw/resources/views/report/EReport/common_report.blade.php ENDPATH**/ ?>