                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left"
                                      action="{{url('promotion_sp_2/store/new')}}"
                                    ...
                                    <div id="wizard" class="form_wizard wizard_horizontal">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <select class="form-control" name="promotion_label"
                                                        ...
                                                        <option value="foc">FOC(Item)</option>
                                                        <option value="foc_value">FOC(Value)</option>
                                        ...
                                        <div id="step-4" style="height: 300px">
                                            ...
                                            <!-- <div class="item form-group">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <select class="form-control" name="district[]" id="district"  multiple="multiple"
                                                            required>
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <select class="form-control" name="thana_id[]" id="thana_id"  multiple="multiple"
                                                            required>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <select class="form-control" name="sub_channel[]" id="sub_channel"  multiple="multiple"
                                                            required>
    ...
    <script>
        ...
        function getPromotionLabel(pType) {
            ...
            if (p_type == "foc") {
                ...
                var element = '<option value="CRT">Crt</option><option value="QTY">Pcs</option>';
                ...
                var element = '';
                var currency='<?php echo Auth::user()->country()->cont_cncy; ?>';
                element = '<option value="'+currency+'">'+currency+'</option>';
                // alert(element);
                $("#offer_type").append(element);
                element = '<option value="Amount">Based On Amount</option>';
                let vl_ord='<option value="order">Order</option>';
                $("#o_type").append(vl_ord);
                $("#promotion_slab_qua").append(element);
            } else {
                var element = '';
