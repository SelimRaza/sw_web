                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            @if($permission->wsmu_crat)
                                <a href="{{ URL::to('promotion_sp_2/create/new')}}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Add New
                                    Promotion SP</a>
                                <a href="{{ URL::to('assignPromotionView')}}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> Assign Promotion</a>
    ...
    <script type="text/javascript">
        ...
        function getReport() {
            ...
            if (acmp_id != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ URL::to('/')}}/promotion_sp_2/filter/report",
                    data: {
                        acmp_id: acmp_id,
                        slgp_id: slgp_id,
                        _token: _token
                      ...
                      //  console.log(data);
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            if (lfcl_id == '1') {
                                ...
                                a_status = 'Inactive';
                                btn_active = '<a href="promotion_sp_2/p_copy/' +r_id+ '" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Copy As </a>&nbsp;&nbsp;';
                            }
                            ...
                            html += '<tr class="tbl_body_gray">' +
                                ...
                                '<td><a href="promotion_sp_2/show/' + r_id + '" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> View</a>&nbsp;&nbsp;' +
                                '<a href="promotion_sp_2/extend_date/' + r_id + '" target="_blank" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit </a>&nbsp;&nbsp;' +
