...
@section('content')
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <div  class="col-md-12 col-sm-12 col-xs-12 tracing">
                                ...
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12"
                                            for="start_date">Sub Category<span class="required"></span>
                                    </label>
                                        <div class="col-md-8 col-sm-8 col-xs-12">
                                            <select class="form-control cmn_select2" name="sb_cat"
                                                    id="sb_cat"
                                                    >
                                                
                                                <option value="">Select </option>
                                                @foreach($item_cat as $cat)
                                                 <option value="{{$cat->id}}">{{$cat->itsg_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                     <label class="control-label col-md-4 col-sm-4 col-xs-12"
                                            for="start_date">SKU Id<span class="required"></span>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="form-control in_tg" id="sku_id" placeholder="" name="sku_id">
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12"
    ...
    <script type="text/javascript">
        ...
        function filterData() {
            ...
            var sb_cat = $("#sb_cat").val();
            var amim_code = $("#sku_id").val();
            ...
            $.ajax({
                type: "POST",
                url: "{{ URL::to('/')}}/getFullOrderDetails",
                data: {
