                                            ...
                                            <div id="order_report" class="col-md-12 col-sm-12 col-xs-12 animate__animated animate__zoomIn">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="reportType"
                                                               id="reportType"
                                                               value="cat_wise_order_report_amt" /> Category Wise Order Report (amount)
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="reportType"
                                                               id="reportType"
                                                               value="cat_wise_order_report_memo"/> Category Wise Order Report (memo)
                                                    </label>
                                                </div>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <label>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="col-md-12 col-sm-12 col-xs-12" style="height:700px;overflow: auto;">
                                    ...
                                    <table id="datatablesa" class="table table-bordered table-responsive"
                                           data-page-length='100'>
                                           <tr id="class_wise_order_summary_amount_headings" style="position:sticky; inset-block-start:0;">
...
<div class="modal fade " id="myModalWardWiseVisit" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <h4 class="text-center">Ward/Union Wise Visit</h4>
        <table class="table table-striped" >
          <thead>
            <tr>
              <th>Sl</th>
...
<div class="modal fade" id="visitMap" role="dialog">
    <div class="modal-dialog modal-lg" style="width:90%;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="googleMap" style="height:650px;">
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            for(var i=0;i<data.length;i++){
                ...
                '<button class="btn btn-danger in_tg" onclick="showVisitMap('+data[i]["id"]+',this,0)" date="'+data[i]['dhbd_date']+'" sr_id="'+data[i]["id"]+'">Map</button></td>'+
                '</tr>';
            }
    ...
    $.ajax({
        ...
        success:function(data){
           ...
           // $('#googleMap').empty();
            ...
            console.log(lat);
            var sicon=window.location.origin;
            var eicon=window.location.origin;
            var wicon=window.location.origin;
            var vicon=window.location.origin;
                sicon+="/theme/image/start_1.png";
                eicon+="/theme/image/end_1.png";
                wicon+="/theme/image/walk3.png";
            const lineSymbol = {
            ...
            zoom:15,
            center: new google.maps.LatLng(data[0]['geo_lat'],data[0]['geo_lon']),
