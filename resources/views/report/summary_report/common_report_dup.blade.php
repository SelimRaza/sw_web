                                        ...
                                        <div class="x_title">
                                            <div class="btnDiv col-md-12 col-sm-12" style="margin-bottom: 5px;">
                                                ...
                                                <button id="send1" type="button"
                                                        class="target col-md-3 col-sm-6 col-xs-6 btn btn-sm btn-success"
                                                        onclick="getSRReport()"> SR Report
                                                </button>
                                                <button id="send2" type="button"
                                                        class="target col-md-3 col-sm-6 col-xs-6 btn btn-sm btn-success"
                                                        onclick="getOutletReport()"> Outlet Report
                                                </button>

                                                <button id="send3" type="button"
                                                        class="target col-md-3 col-sm-6 col-xs-6 btn btn-sm  btn-success"
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12" style="font-size: 12px;">
                                            <div id="sr_report" class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> SR Activity
                                                    </label>
                                                </div>
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> SR Productivity
                                                    </label>
                                                </div>
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> SR Activity (Hourly)
                                                    </label>
                                                </div>
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> SR Summary (By Group)
                                                    </label>
                                                </div>
                                            </div>
                                            <div id="outlet_report" class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> Market Outlet vs SR Outlet
                                                    </label>
                                                </div>
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                            ...
                                            <div id="order_report" class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> Order Summary
                                                    </label>
                                                </div>
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> Order Details
                                                    </label>
                                                </div>
                                                <div class="col-md-4 col-sm-4 ">
                                                    <label>
                                                        <input type="radio" class="flat" name="classType" id="classType"
                                                               value="w_class" checked/> Order Vs Delivery
                                                    </label>
                                                </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 ">
                                            ...
                                            <div id="sales_heirarchy">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="name">From
                                                    ...
                                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="name">To
                                                        Date<span
                                                                class="required">*</span>
                                                    </label>
                                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                            ...
                                            <div id="govt_heirarchy">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="name">Ward<span
                                                                class="required"></span>
                                                    </label>
                                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="name">Market<span
                                                                class="required"></span>
                                                    </label>
                                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                                    ...
                                                    <label class="control-label col-md-1 col-sm-1 col-xs-12" for="name">Select
                                                        Outlet<span
                                                                class="required">*</span>
                                                    </label>
                                                    <div class="col-md-3 col-sm-3 col-xs-12">
