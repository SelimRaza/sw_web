...
@section('content')
                ...
                <div class="col-md-12">
                    <div style="padding: 10px;">
                        ...
                        <div align="right">
                            ...
                            <button onclick="exportTableToCSV('group_status_<?php echo date('Y_m_d'); ?>.csv')"
    ...
    <script type="text/javascript">
        ...
        function filterData() {
            ...
            $.ajax({
                type: "POST",
                url: "{{ URL::to('/')}}/group_status/filterActivityStatusSymmary",
                data: {
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += '<tr>' +
                            ...
                            "<td><a target='_blank' href='{{ URL::to('/')}}/group_status/activeSummaryDetails/" + data[i].depertment_id + "/" +start_date +"/" +end_date+ "' class='btn btn-info btn-xs'></i>"+ data[i].att_user +" </a></td>" +
                            '<td>' +num1 + '</td>' +
                            "<td><a target='_blank' href='{{ URL::to('/')}}/group_status/inactiveSummaryDetails/" + data[i].depertment_id + "/" +start_date +"/" +end_date+ "' class='btn btn-info btn-xs'></i>"+ notatt +" </a></td>" +
                            '<td>' +num2 + '</td>' +
                           '</tr>';
                        count++;
                    }
