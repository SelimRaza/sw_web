                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped projects">
                                ...
                                <tbody id="cont">
                                @foreach($emp_dates  as $index => $emp_data)
                                    <tr>
                                        <td>{{$index+1}}</td>
                                        <td>{{$emp_data->emp_id}}</td>
                                        <td>{{$emp_data->user_name}}</td>
                                        <td>{{$emp_data->name}}</td>
                                        <td>{{$emp_data->role}}</td>
                                        <td>{{$emp_data->date}}</td>
                                        <td>{{$emp_data->att_count}}</td>
                                        <td>{{$emp_data->outlet_count}}</td>
                                        <td>{{$emp_data->visited_count}}</td>
                                        <td>{{$emp_data->time_spend}}</td>
                                        <td>{{$emp_data->checkin_count}}</td>
                                        <td>{{$emp_data->productive_count}}</td>
                                        <td>{{$emp_data->start_time}}</td>
                                        <td>{{$emp_data->end_time}}</td>
                                        <td>{{$emp_data->note_count}}</td>
                                        <td>{{$emp_data->loc_count}}</td>
                                        <td>
                                            <a target='_blank' href="{{ URL::to("/")}}/activity/attendanceSummaryDetails/{{$emp_data->emp_id}}/{{$emp_data->date}}"
                                               class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Attendance
                                                Detials
                                            </a>
                                            <a target='_blank' href="{{ URL::to("/")}}/activity/noteSummaryDetails/{{$emp_data->emp_id}}/{{$emp_data->date}}"
                                               class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Note Detials
                                            </a>
                                            <a target='_blank' href="{{ URL::to("/")}}/activity/summaryLocationAll/{{$emp_data->emp_id}}/{{$emp_data->date}}"
                                               class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Activity In
                                                Map
                                            </a>
                                            <a target='_blank' href="{{ URL::to("/")}}/activity/mySummaryBy/{{$emp_data->emp_id}}/{{$emp_data->date}}"
                                               class="btn btn-primary btn-xs"><i class="fa fa-folder"></i>More Details
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
