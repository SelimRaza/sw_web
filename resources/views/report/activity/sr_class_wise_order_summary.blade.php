...
@section('content')
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>SR Class Wise Order Summary</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <center><strong> ::: SR Class Wise Order Summary :::
                                </strong></center>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left" action="{{URL::to('/data_export/dataE')}}"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <select class="form-control" name="sales_group_id" id="sales_group_id" onchange="getItemClass(this.value)">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <select class="form-control" name="zone_id" id="zone_id" onchange="getSR(this.value)">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <select class="form-control" name="sr_id" id="sr_id">
                                            <option value="">Select SR ID</option>
                                        </select>
                                    </div>

                                    <label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">Item Class<span
                                                class="required">*</span>
                                    </label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
    ...
    <script type="text/javascript">
        ...
        function getItemClass(itgp_id) {

            var _token = $("#_token").val();
            $('#ajax_load').css("display", "block");
            $.ajax({
                type: "POST",
                url: "{{ URL::to('/')}}/load/report/getItemClass",
                data: {
                    itgp_id: itgp_id,
                    _token: _token
                },
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        console.log(data[i]);
                        html += '<option value="' + data[i].id + '">' + data[i].itcl_code + " - " + data[i].itcl_name + '</option>';
                    }
        ...
        function getReport() {
            ...
            if (acmp_id != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ URL::to('/')}}/load/filter/srvclassSummary",
                    data: {
                        acmp_id: acmp_id,
                        zone_id: zone_id,
                        dirg_id: dirg_id,
