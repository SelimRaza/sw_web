                  ...
                  <div class="tab-content">
                    <div id="{{'stat'.$sld->STAFFID.$sld->oid}}" class="tab-pane fade in active">
                      <div class="pg-block">
                        ...
                        <div class="progress pg-content-pg">
                          <div class="progress-bar progress-bar-striped" role="progressbar" style="width:{{$sld->ACHV_PERCENTAGE>100?100:$sld->ACHV_PERCENTAGE}}%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                       </div>
                  ...
                  <div class="tab-content">
                    <div id="{{'stat'.$sld->STAFFID}}" class="tab-pane fade in active">
                      ...
                      <div class="pg-block">
                        <p class="pg-content">P.S</p>
                        <div class="progress pg-content-pg">
                          <div class="progress-bar progress-bar-striped" role="progressbar" style="width:{{$sld->TGT_AMOUNT?(number_format($sld->ACHV_AMOUNT*100/$sld->TGT_AMOUNT,1)):0}}%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                       </div>
                        <p class="pg-content_amnt">&nbsp;&nbsp;{{$sld->TGT_AMOUNT?(number_format($sld->ACHV_AMOUNT*100/$sld->TGT_AMOUNT,1)):0}}%</p>
                      </div>
                  ...
                  <div class="tab-content">
                    <div id="{{'stat'.$sld->STAFFID.$sld->oid}}" class="tab-pane fade in active">
                      <div class="pg-block">
                        <p class="pg-content">Achv</p>
                        <div class="progress pg-content-pg">
                          <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" style="width:{{$sld->ACHV_PERCENTAGE>100?100:$sld->ACHV_PERCENTAGE}}%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                       </div>
                      <p class="pg-content_amnt">&nbsp;&nbsp;{{$sld->ACHV_PERCENTAGE}}%</p>
                      </div>
