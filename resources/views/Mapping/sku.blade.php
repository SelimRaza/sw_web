...
@section('content')
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control cmn_select2" name="itcg_id" id="itcg_id"
                                        ...
                                        @foreach($category_list as $cat)
                                            <option value="{{ $cat->id }}">{{ ucfirst($cat->itcg_name)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        html += "<td><a  href='{{ URL::to('/')}}/sku/" + data[i].id +'/edit'+"' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i>Edit</a>";
        ...
        function getSubCategory(cat_id) {
            $.ajax({
                type: "GET",
                url: "{{ URL::to('/')}}/getSubCategory/"+cat_id,
                cache: false,
                dataType: "json",
                success: function (data) {
                    $('#ajax_load').css("display", "none");
        ...
        function itemLfclChange(v) {
            ...
            $.ajax({
                type: "GET",
                url: "{{ URL::to('/')}}/itemLfclChange/"+id+"/"+lfcl_id,
                cache: false,
                dataType: "json",
                success: function (data) {
