            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/site-mapping')}}">Site mapping</a>
                        </li>
                    ...
                    @if($permission->wsmu_crat)
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h3>Route Site Mapping</h3>
                                    @if($permission->wsmu_crat)                                        
                                        <a href="{{ URL::to('/download/rsmp/format')}}" style="text-decoration:underline">Click here to download format</a>
