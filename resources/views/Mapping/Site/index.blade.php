...
@section('content')
        ...
        <div class="">
            <div class="page-title">
                ...
                @if ($permission->wsmu_crat)
                    <a href="{{ URL::to('/bulk/route/site')}}" style="color:darkred;font-weight:bold;" target="_blank"><i class="fa fa-upload"></i> Upload</a>
                @endif
                </div>
            </div>
                            ...
                            <div class="form-group col-md-5 col-sm-5 col-xs-12">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <select class="form-control cmn_select2" name="rout_id" id="rout_id"
                                        ...
                                        @foreach($rout_list as $rout)
                                            <option value="{{ $rout->id }}">{{ '('.$rout->rout_code.') '.ucfirst($rout->rout_name)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function addSiteToRoute(){
            ...
            $.ajax({
                type: "get",
                url: "{{URL::to('/')}}/add/site/rsmp/"+rout_id+"/"+site_code,
