            ...
            <div class="page-title">
                <div class="title_left">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Block Order Release</strong>
                        </li>
                    </ol>
                </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="{{ URL::to('block/specialReleaseAction/'.$orderMaster->id)}}"
                                  method="post">
                                {{csrf_field()}}
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="usr"
                                                   value="{{$orderMaster->budget}}" readonly>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    @foreach($orderLine as $index => $orderLine1)
                                                        <tr>
                                                            <td>{{$orderLine1->Product_id}}<input
                                                                        class="form-control"  type="hidden" name="discountLineId[]"
                                                                        value="{{$orderLine1->id}}"></td>
                                                            ...
                                                            <td>
                                                                @if($orderLine1->spDis>0)
                                                                    <input step="any" max="{{$orderLine1->spDis}}" class="form-control" type="number"
                                                                           name="discountAmount[]"
                                                                           value="{{$orderLine1->Discount}}">
                                                                @else
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="nav navbar-light panel_toolbox">
                                            @if($orderMaster->order_status==17)
                                                <input
