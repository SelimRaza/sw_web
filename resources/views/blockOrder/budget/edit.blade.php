            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/specialBudget')}}">All Special Budget</a>
                        </li>
                        <li class="active">
                        ...
                        <div class="x_content">
                            ...
                            <table class="table table-striped projects">
                                ...
                                @foreach($specialBudgetLine as $index => $specialBudgetLine1)
                                    <tr>
                                        <td>{{$index+1}}</td>
                                        <td>{{$specialBudgetLine1->spbd_amnt}}</td>
                                        <td>{{$specialBudgetLine1->spbd_type}}</td>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{route('specialBudget.update',$specialBudgetMaster->id)}}"
