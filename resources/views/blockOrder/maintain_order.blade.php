                                ...
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="chnl_id"
                                            ...
                                            @foreach($chnl_list as $chnl)
                                            <option value="{{$chnl->id}}">{{$chnl->chnl_code.'-'.$chnl->chnl_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="dlrm_id"
                                            ...
                                            <option value="{{$dlrm->id}}">{{$dlrm->dlrm_code.'-'.$dlrm->dlrm_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="sv_id"
                                            ...
                                            <option value="{{$sv->id}}">{{$sv->aemp_usnm.'-'.$sv->aemp_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += "<td><a target='_blank' href='{{ URL::to('/')}}/printer/order/" + data[i].cont_id + "/" + data[i].order_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i>Print </a>";
                        if (data[i].status_id == 17) {
                            html += "<a target='_blank' href='{{ URL::to('/')}}/block/specialRelease/" +  data[i].so_id + "' class='btn btn-warning btn-xs'><i class='fa fa-pencil'></i> SP Release </a>";
                        }
                        if (data[i].status_id == 9) {
                            html += "<a target='_blank' href='{{ URL::to('/')}}/block/creditRelease/" +  data[i].so_id + "' class='btn btn-warning btn-xs'><i class='fa fa-pencil'></i> CDB Release </a>";
                        }
                        if (data[i].status_id == 14) {
                            html += "<a target='_blank' href='{{ URL::to('/')}}/block/overDueRelease/" +  data[i].so_id + "' class='btn btn-warning btn-xs'><i class='fa fa-pencil'></i>ODB Release </a>";
                        }
                        html += '</td></tr>';
                        count++;
                    }
