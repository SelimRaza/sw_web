                ...
                <div class="col-md-12">
                    ...
                    <div class="x_panel" id="d_report" style="overflow: auto;">
                        <div class="x_content">
                            ...
                            <table id="datatables" class="table table-bordered table-responsive search-table" data-page-length='100'>
                                <thead>
                                <tr class="tbl_header">
                                    <th>SL</th>
                                    <th>Code</th>
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            html += '<tr>' +
                                ...
                                '<button value=" ' + data[i]['id'] + '" class="btn btn-danger btn-xs" ' + astatus + ' onclick="if(confirm(\'Do you want to create distributor credential?\'))getDealerLogin(this.value)" ><i class="fa fa-pencil"></i>Create Dealer Loginx</button></td>' +
