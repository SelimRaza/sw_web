                    ...
                    <ol class="breadcrumb">
                        ...
                        @if($permission->wsmu_crat)
                            <li class="label-success">
                                <a href="{{ URL::to('/ward-sr-mapping/depotEmployeeMappingUploadFormat')}}">Ward Employee
                                    Format</a>
                            </li>
                        @endif
                    </ol>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left"
                                      action="{{URL::to('/ward-sr-mapping/depotEmployeeMappingUpload')}}"
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="{{URL::to('/ward-sr-mapping/dataExportWardSRMappingInfoData')}}"
                ...
                <div id="ward-mapping" class="col-md-12 col-sm-12 col-xs-12" style="display: none">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left"
                                      action="{{URL::to('ward-sr-mapping/mapping')}}"
                                      method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" id="_token" value="<?php echo csrf_token(); ?>">
                                    {{csrf_field()}}
                                    <div class="row">
    ...
    <script type="text/javascript">
        ...
        function getUserWard(){
          ...
          if(staff_code==""){
            ...
            var url = "{{url('/json/get/sr_wise/ward/list')}}/"+staff_code;
        ...
        function deleteSRFromWard(id){
          ...
          if(x){
             ...
             $.ajax({
                ...
                type: "GET",
                url: "{{url('/json/delete/sr_wise/ward/list')}}/"+id,
