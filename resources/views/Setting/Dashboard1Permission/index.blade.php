            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>All Dashboard1 Permission</strong>
                        </li>
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @if($permission->wsmu_crat)
                                <a class="btn btn-success btn-sm" href="{{ URL::to('/dashboard1Permission/create')}}" style="float: right; margin-top: -30px;"><span
                                        ...
                                        <td>
                                            @if($permission->wsmu_delt)
                                                <form style="display:inline"
                                                      action="{{route('dashboard1Permission.destroy',$dataDashboardPermission->id)}}"
