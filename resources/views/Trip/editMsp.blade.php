            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/msp')}}">MSP  List</a>
                        </li>
                        <li class="active">
                            <strong>Edit MSP </strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form class="form-horizontal form-label-left" action="{{route('msp.update',$msp->id)}}"
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="mspm_name" name="mspm_name" class="form-control col-md-7 col-xs-12 in_tg"
                                                           ...
                                                           placeholder="MSP  " required
                                                           type="text" value="{{$msp->mspm_name}}">
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">MSP
                                                    Code <span
                                                            class="required">*</span>
                                                </label>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="mspm_code" name="mspm_code" class="form-control col-md-7 col-xs-12 in_tg"
                                                           data-validate-length-range="6" data-validate-words="2"
                                                           placeholder=" Discount Code" required="required"
                                                           type="text" value="{{$msp->mspm_code}}" disabled>
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="start_date" name="start_date"
                                                           ...
                                                           data-validate-length-range="6" data-validate-words="2"
                                                           value="{{$msp->mspm_sdat}}" type="text" disabled>
                                                </div>
                                            </div>
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input id="end_date" name="end_date"
                                                           class="form-control col-md-7 col-xs-12 in_tg"
                                                           data-validate-length-range="6" data-validate-words="2"
                                                           value="{{$msp->mspm_edat}}" required="required" type="text">
                                                </div>
                                            </div>
                                           <div class="item form-group">
