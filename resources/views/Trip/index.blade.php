                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            @if($permission->wsmu_crat)
                                <a href="{{ URL::to('/create/trip')}}" class="btn btn-success btn-sm">Create Trip</a>
                            @endif
                        ...
                        <div class="x_content">
                                ...
                                <div class="form-group col-md-4 col-sm-4 col-xs-12">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="start_date">End Date<span
                                            class="required">*</span>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="dlrm_id" id="dlrm_id">
                                            ...
                                            @foreach ($dlrm_list as $dlrm)
                                                <option value="{{ $dlrm->id }}">{{ $dlrm->dlrm_code . '-' . $dlrm->dlrm_name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="sv_id">Trip State<span
                                            class="required"></span>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="dlrm_id" id="dlrm_id">
                                            ...
                                            <option value="">Select</option>
                                            <option value="31">Available</option>
                                            <option value="20">On Transit</option>
                                            <option value="5">EOT</option>
                                            <option value="25">Trip Closed</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="sv_id">DM<span
                                            class="required"></span>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <select class="form-control cmn_select2" name="dlrm_id" id="dlrm_id">
                                ...
                                <div class="item form-group col-md-4 col-sm-4 col-xs-12 gvt_filter">
                                    <label class="control-label col-md-4 col-sm-4 col-xs-12" for="start_date">Trip No<span
                                            class="required"></span>
                                    </label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="form-control in_tg" id="ordm_ornm"
                                            placeholder="Trip no" name="ordm_ornm">
                                    </div>
                                </div>
                                <div class="form-group col-md-12 col-sm-12 col-xs-12 gvt_filter">
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12 col-md-offset-10 col-sm-offset-10">
                                        <button class="btn btn-success btn-block" type="submit"
                                            onclick="filterData()">Show</button>
                                    </div>
                                </div>
