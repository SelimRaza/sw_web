            ...
            <div class="page-title">
                <div class="title_left">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Collection Verify</strong>
                        </li>
                    </ol>
                </div>
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="{{ URL::to('collection/verifyUpdate/'.$collection->payment_id)}}"
                                  method="post">
                                {{csrf_field()}}
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="col-md-4">
                                ...
                                @if($collection->lfcl_id==12)
                                    <input type="hidden" readonly id="token_code" name="token_code"
                                           class="form-control"
                                           value="<?php echo uniqid(); ?>"/>
                                    <!-- <button type="submit" class="btn btn-success" name="btn-reject">Reject</button>-->
                                    <button type="submit" class="btn btn-success" name="btn-update"
                                            >Verify
                                    </button>
                                    <p class="btn btn-success" id="myBtn">Reject</p>
                                    ...
                                    <div id="myModal" class="modal">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <input type="text" id="reject_note" name="reject_note" class="form-control"
                                                   value=""/>
                                            <label for="usr">Reject Reason:</label>
                                            <select class="form-control" id="reject_id" name="reject_id">


                                                @foreach($rejectReason as $index => $rejectReason1)
                                                <option value={{$rejectReason1->id}}>{{$rejectReason1->clrj_name}}</option>
                                                @endforeach
                                            </select>
                                            <button type="submit" class="btn btn-success" name="btn-reject">Reject
                                            </button>
                                        </div>
