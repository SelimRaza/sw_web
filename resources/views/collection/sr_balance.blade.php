...
@section('content')
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{ URL::to('/sr-balance') }}"
                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            @error('staff_id')
                                                <small class="required-field">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
    ...
    <script type="text/javascript">
        ...
        function getRefData(value) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ URL::to('/') }}/sr-collection-ref-data",
                data: {
                    ref_no: ref_no,
                    _token: _token
                },
