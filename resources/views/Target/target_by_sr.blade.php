                                    ...
                                    <table class="table table-striped projects">
                                        ...
                                        @foreach($bySrdata as $index=>$bySrdata1)
                                            <tr>
                                                ...
                                                <td>
                                                  <a href="{{URL('target/removeBySr',[$bySrdata1->aemp_id,$bySrdata1->year,$bySrdata1->month,$manager_id])}}" class="btn btn-danger btn-sm"><i class="fa fa-pencil"></i>Remove</a>
                                                </td>
