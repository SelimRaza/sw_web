    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        html += "<td><a  href='{{ URL::to('/')}}/target/bySalesMan/" + data[i].supervisor_id + "/" + data[i].year +"/" + data[i].month_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> View By SR </a>";
                        html += "<a  href='{{ URL::to('/')}}/target/byItem/" + data[i].supervisor_id + "/" + data[i].year + "/" + data[i].month_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> View By Item </a>";
                        html += "<a  href='{{ URL::to('/')}}/target/byCategory/" + data[i].supervisor_id + "/" + data[i].year +"/" + data[i].month_id + "' class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> View By Category </a>";
        ...
        function removeTarget (sp_id,year,month){
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                type: "get",
                url: "{{ URL::to('/')}}/target/remove/"+sp_id+'/'+year+'/'+month+'/'+manager,
                cache: false,
                dataType: "json",
                success: function (data) {
                    //onsole.log(data);
