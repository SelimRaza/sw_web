                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                      action="{{ URL::to('self_account/cash_out_add/'.$selfAccount->id)}}"
                                      method="GET">
                                    {{csrf_field()}}
                                    {{method_field('PUT')}}
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Out For
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="cash_move_type_id"
                                                ...
                                                @foreach ($cashMoveTypes as $cashMoveType)
                                                    @if($cashMoveType->cash_type_id==2)
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Out From
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <td>
                                            @if($permission->wsmu_delt)
                                                <form style="display:inline"
                                                      action="{{ URL::to('self_account/cash_out_delete/'.$cashMovement->id)}}"
