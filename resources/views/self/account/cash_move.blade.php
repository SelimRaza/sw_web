                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                      action="{{ URL::to('self_account/cash_move_add/'.$selfAccount->id)}}"
                                      method="GET">
                                    {{csrf_field()}}
                                    {{method_field('PUT')}}
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Move
                                            From
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="from_cash_source_id"
                                                    id="from_cash_source_id"
                                                    required>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Move To
                                            <span class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="to_cash_source_id" id="to_cash_source_id"
                                                    required>
                                                <option value="">Select</option>
                                                @foreach ($cashSources as $cashSource)
                                                    <option value="{{ $cashSource->id }}">{{ $cashSource->name }}</option>
                                        ...
                                        <td>
                                            @if($permission->wsmu_delt)
                                                <form style="display:inline"
                                                      action="{{ URL::to('self_account/cash_move_delete/'.$cashMovement->id)}}"
