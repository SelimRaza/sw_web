    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                ...
                <form action="{{ URL::to('/location_details')}}" method="get">
                            ...
                            <table id="datatables" class="table search-table font_color" data-page-length='100'>
                                ...
                                @foreach($locationData as $index => $locationData1)
                                    <tr class="tbl_body_gray">
                                        ...
                                        <td>{{$locationData1->locd_name}}</td>
                                        <td>{{$locationData1->locd_code}}</td>
                                        <td>{{$locationData1->ltyp_name}}</td>
                                        <td>{{$locationData1->geo_adrs}}</td>
                                        <td>
                                            @if($permission->wsmu_read)
                                                <a href="{{route('location_details.show',$locationData1->id)}}"
