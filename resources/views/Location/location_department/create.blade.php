...
@section('content')
            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>New Location Department</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <button class="btn btn-success btn-sm" onclick="addLocationDepartment();"><span
                                        class="fa fa-plus-circle" style="color: white; font-size: 1.3em"></span>&nbsp;&nbsp;<b>Add
                                    New Location Department</b></button>
                        ...
                        <div class="x_content" id="add_department">

                            <form class="form-horizontal form-label-left" action="{{route('location_department.store')}}"
                                  method="post" enctype="multipart/form-data">
                                {{csrf_field()}}

                                <div class="item form-group">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12" for="name" style="text-align: left">Location Company
                                        <span
                                                class="required">*</span>
                                    </label>
                        ...
                        <div class="x_content" id="upload_department">
                            <form class="form-horizontal form-label-left"
                                  action="{{URL::to('/location_department/file/insert')}}"
                                  method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <strong>
                                ...
                                <div class="ln_solid"></div>
                                <div class="col-md-12">
                                    <a class="btn btn-danger btn-sm" href="{{ URL::to('location_department/format/download')}}"><span
    ...
    <script>
        ...
        $('#upload_department').hide();
        function addLocationDepartment() {
            $('#upload_department').hide();
            $('#add_department').show();
        }

        function addUploadFile() {
            $('#upload_department').show();
            $('#add_department').hide();
        }
