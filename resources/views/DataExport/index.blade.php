                ...
                <div class="col-md-12">
                    <div style="padding: 10px;">
                        ...
                        <div id="sales_heirarchy" class="form-row animate__animated animate__zoomIn">
                            <div class="form-group col-md-6">
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    {{--<select class="form-control cmn_select2" name="acmp_id" id="acmp_id" onchange="getGroup(this.value,1)">
                                        <option value="">Select Company</option>
                                        @foreach($companies as $company)
                                            <option value="{{ $company->id }}">{{ ucfirst($company->acmp_name) }} ({{ $company->acmp_code }})</option>
                                        @endforeach
                                    </select>--}}<select class="form-control cmn_select2" name="aemp_id" id="aemp_id">
                                        <option value="">Select user</option>
                                        @foreach($employeies as $employee)
                                            <option value="{{ $employee->id }}">{{ ucfirst($employee->aemp_name) }}
                                                ({{ $employee->aemp_usnm }})
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div align="right">
                            ...
                            <button onclick="exportTableToCSV('activity_summary_report_{{ date('Y_m_d') }}.csv')"
