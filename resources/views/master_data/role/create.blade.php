                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <button class="btn btn-success btn-sm" onclick="getAddRole();"><span
                        ...
                        <div class="x_content" id="add_role">

                            <form class="form-horizontal form-label-left" action="{{route('role.store')}}"
                                  method="post">
                                {{csrf_field()}}
                        ...
                        <div class="x_content" id="upload_role">
                            <form class="form-horizontal form-label-left"
                                  action="{{URL::to('/role/file/insert')}}"
                                  method="post" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <strong><center>::: Upload File :::</center></strong>
                                <div class="ln_solid"></div>
                                <div class="col-md-12">
                                    <a class="btn btn-danger btn-sm" href="{{ URL::to('role/format/download')}}"><span
