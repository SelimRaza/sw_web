    ...
    <div class="right_col" role="main">
        <div class="">
            <div class="page-title">
                ...
                <form action="{{ URL::to('/district')}}" method="get">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            @if($permission->wsmu_crat)
                                <a class="btn btn-success btn-sm" href="{{ URL::to('/district/create')}}"><span
                        ...
                        <div class="x_content">
                            {{$districts->appends(Request::only('search_text'))->links()}}
                            <table id="datatable" class="table font_color" data-page-length='50'>
                                ...
                                @foreach($districts as $index => $district)
                                    <tr class="tbl_body_gray">
                                        ...
                                        <td>{{$district->dsct_name}}</td>
                                        <td>{{$district->dsct_code}}</td>
                                        <td>{{$district->division()->disn_name}}</td>
                                        <td>
