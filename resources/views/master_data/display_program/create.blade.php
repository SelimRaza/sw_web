            ...
            <div class="page-title">
                <div class="title_left">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>New Display Program</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{route('display-program.store')}}"
                                  method="post">
                                {{csrf_field()}}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input id="name" class="form-control col-md-7 col-xs-12"
                                               ...
                                               placeholder="Width" required="required" type="text">
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <input id="name" class="form-control col-md-7 col-xs-12"
                                               data-validate-length-range="6" data-validate-words="2" name="max_height"
                                               placeholder="Height" required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
