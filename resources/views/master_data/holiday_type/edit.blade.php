            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/holiday_type')}}">All Holiday Type</a>
                        </li>
                        <li class="active">
                            <strong>Edit Holiday Type</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{route('holiday_type.update',$holidayType->id)}}"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
