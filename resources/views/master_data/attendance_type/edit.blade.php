            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/attendance_type')}}">All Attendance Type</a>
                        </li>
                        <li class="active">
                            <strong>Edit Attendance Type</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{route('attendance_type.update',$attendanceType->id)}}"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
