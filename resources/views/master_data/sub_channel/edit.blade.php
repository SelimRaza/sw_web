        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Edit Sub Channel</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h4><strong>Sub Channel </strong></h4>
                            <div class="clearfix"></div>
                        </div>

                        <div class="x_content">

                            <form class="form-horizontal form-label-left" action="{{route('sub_channel.update',$subChannel->id)}}"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="channel_id" id="channel_id" required>
                                            <option value="{{$subChannel->channel()->id}}">{{$subChannel->channel()->chnl_name}} </option>
                                            @foreach ($channels as $channel)
                                                @if($channel->id!=$subChannel->channel()->id)
