            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/division')}}">All Division</a>
                        </li>
                        <li class="active">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{route('division.store')}}"
                                  method="post">
                                {{csrf_field()}}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="company" id="sales_group_id" required>
                                            <option value="">Select Company</option>
                                            @foreach ($salesGroups as $salesGroup)
                                                <option value="{{ $salesGroup->id }}">{{ ucfirst($salesGroup->acmp_name) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
