                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            @if($permission->wsmu_crat)
                                ...
                                <a class="btn btn-success btn-sm" href="{{ URL::to('/region/create')}}">Add New</a>
                        ...
                        <div class="x_content">
                            ...
                            <table id="datatable" class="table table-bordered projects" data-page-length="50">
                                ...
                                <tbody>
                                @foreach($Region as $index=>$region)
                                    <tr>
                                        <td>{{$index+1}}</td>
                                        <td>{{$region->dirg_name}}</td>
                                        <td>{{$region->dirg_code}}</td>
                                        <td>
                                            ...
                                            @if($permission->wsmu_delt)
                                                <form style="display:inline"
                                                    ...
                                                    <input class="btn btn-danger btn-xs" type="submit"
                                                           value="<?php echo $region->lfcl_id == 1 ? 'Active' : 'Inactive'?>"
