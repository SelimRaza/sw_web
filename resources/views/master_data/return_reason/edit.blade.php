            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Edit Return Reason</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h4><strong>Return Reason</strong></h4>
                            <div class="clearfix"></div>
                        </div>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="{{route('return_reason.update',$category->id)}}"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
