            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/sub-category')}}">All Sub Category</a>
                        </li>
                        <li class="active">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="category_id" id="category_id" required>
                                            <option value="{{$subCategory->category()->id}}">{{$subCategory->category()->itcg_name}} </option>
                                            @foreach ($categorys as $category)
                                                <option value="{{ $category->id }}">{{ $category->itcg_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
