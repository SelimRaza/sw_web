                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"
                                  action="{{route('group_site.update',$site->id)}}" enctype="multipart/form-data"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"
                                               ...
                                               placeholder="Group Name" required="required" type="text" readonly
                                               value="{{$salesGroup->name}}">
                                        <input id="sales_group_id" name="sales_group_id"  type="hidden" readonly
                                               value="{{$salesGroup->id}}">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="base_id" id="base_id"
                                                required>
                                            <option value="{{$baseSiteMapping->base()->id}}">{{$baseSiteMapping->base()->name}} </option>
                                            @foreach ($bases as $base)
                                                @if($base->id!=$baseSiteMapping->base()->id)
