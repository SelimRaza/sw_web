                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" action="{{route('base.update',$base->id)}}"
                                  method="post">
                                {{csrf_field()}}
                                {{method_field('PUT')}}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control" name="thana_id" id="thana_id" required>
                                            <option value="{{$base->thana()->id}}">{{$base->thana()->than_name}} </option>
                                            @foreach ($thanas as $thana)
                                                <option value="{{ $thana->id }}">{{ ucfirst($thana->than_name) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
