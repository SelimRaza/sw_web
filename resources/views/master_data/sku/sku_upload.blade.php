                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            @if($permission->wsmu_crat)
                                <a class="btn btn-success btn-sm" href="{{route('skuUploadFormat')}}">Generate Item Upload Format </a>
                            @endif

{{--                            @if($permission->wsmu_crat)--}}
{{--                                <a class="btn btn-success btn-sm" href="{{route('skuInactiveFormat')}}">Generate Format </a>--}}
{{--                            @endif--}}
...
{{--                            <form class="form-horizontal form-label-left" action="{{URL::to('/sku/active_inactive')}}"--}}
                            <form class="form-horizontal form-label-left" action="{{route('skuBulkUpload')}}"
