            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>All Holiday</strong>
                        </li>
                        @if($permission->wsmu_crat)
                            <li class="label-success">
                                <a href="{{ URL::to('/holiday/create')}}">New Holiday</a>
                            </li>
                        @endif
                    </ol>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($permission->wsmu_read)
                                                <a href="{{ URL::to('holiday/policy/'.$holiday->id)}}"
                                                   class="btn btn-info btn-xs"><i class="fa fa-pencil"></i>Policy
                                                </a>
                                            @endif
                                            @if($permission->wsmu_delt)
                                                <form style="display:inline"
                                                    ...
                                                    <input class="btn btn-danger btn-xs" type="submit"
                                                           value="<?php echo $holiday->status_id == 5 ? 'Refresh' : 'Active'?>"
                                                          >
                                                    </input>
                                                </form>
                                            @endif
