...
@section('content')
            ...
            <div class="page-title">
                <div class="title_left">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ URL::to('/outlet_grade')}}">All Outlet Category</a>
                        </li>
                        <li class="active">
                            <strong>New Outlet Category</strong>
                        </li>
                    </ol>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <button class="btn btn-success btn-sm" onclick="getAddOutletCategory();"><span
                                        class="fa fa-plus-circle" style="color: white; font-size: 1.3em"></span>&nbsp;&nbsp;<b>Add
                                    New Outlet Category</b></button>
                        ...
                        <div class="x_content" id="add_outlet_category">

                            <form class="form-horizontal form-label-left" action="{{route('outlet_grade.store')}}"
                                  method="post">
                                {{csrf_field()}}
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <button id="send" type="submit" class="btn btn-primary"><i class="fa fa-check-circle"></i> Save</button>
                                    </div>
                                </div>
                            </form>
                        </div>

                        <div class="x_content" id="upload_outlet_category">
                            <form class="form-horizontal form-label-left"
                                  action="{{URL::to('/outlet_grade/file/insert')}}"
                                ...
                                <div class="ln_solid"></div>
                                <div class="col-md-12">
                                    <a class="btn btn-danger btn-sm" href="{{ URL::to('outlet_grade/format/download')}}"><span
    ...
    <script>
        $('#upload_outlet_category').hide();
        function getAddOutletCategory() {
            $('#upload_outlet_category').hide();
            $('#add_outlet_category').show();
        }

        function addUploadFile() {
            $('#upload_outlet_category').show();
            $('#add_outlet_category').hide();
        }
    </script>
@endsection