                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form style="display:inline"
                                  action="{{ URL::to('sales-group-data/emp_add/'.$salesGroup->id)}}"
                            ...
                            <table class="table table-striped projects">
                                ...
                                @foreach($salesGroupEmps as $index=>$salesGroupEmp)
                                    <tr>
                                        <td>{{$index+1}}</td>
                                        <td>{{$salesGroupEmp->emp_id}}</td>
                                        <td>{{$salesGroupEmp->employee()->name}}</td>
                                        <td>{{$salesGroupEmp->employee()->user()->email}}</td>
                                        <td>
                                            <form style="display:inline"
                                                  action="{{ URL::to('sales-group-data/emp_delete/'.$salesGroupEmp->id)}}"
                                                  class="pull-xs-right5 card-link" method="GET">
                                                {{csrf_field()}}
                                                {{method_field('DELETE')}}
