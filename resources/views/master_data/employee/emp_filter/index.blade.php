    ...
    <script type="text/javascript">
        ...
        function getReport() {
            ...
            if (sr_id != "" || sv_id !="") {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ URL::to('/')}}/employee/filter/empdetails",
                    data: {
                        acmp_id: acmp_id,
                        slgp_id: slgp_id,
                        zone_id: zone_id,
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            html += '<tr class="tbl_body_gray">' +
                                ...
                                if(permission.wsmu_delt){
                                    html+= '<form style="display:inline" action="employee/' + r_id + '/reset" class="pull-xs-right5 card-link" method="POST">{{csrf_field()}}{{method_field("PUT")}}<input class="btn btn-danger btn-xs" type="submit" value="Pass Reset" onclick="return ConfirmReset()"></input></form>';
                                }
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            html += '<tr class="tbl_body_gray">' +
                                ...
                                if(permission.wsmu_delt){
                                    html+= '<form style="display:inline" action="employee/' + r_id + '/reset" class="pull-xs-right5 card-link" method="POST">{{csrf_field()}}{{method_field("PUT")}}<input class="btn btn-danger btn-xs" type="submit" value="Pass Reset" onclick="return ConfirmReset()"></input></form></td></tr>';
                                }
