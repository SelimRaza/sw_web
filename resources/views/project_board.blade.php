...
@if($pt_show==1)
    <div class="col-md-12 col-sm-12 col-xs-12 " style="background-color:#fff; margin-top:-10px;">
        <div class="">
          <div class="">
            @if($parent_emp)
            <h4 >{{$pt_show==1?$parent_emp[0]->role_name."-".$parent_emp[0]->aemp_name."-".$parent_emp[0]->aemp_usnm:''}}<small></small></h4>
            @endif
          </div>
        </div>
    </div>
@endif
    ...
    <div class="row tile_count">
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" >
        ...
        @if($employee)
        <div class="count" onclick="loadUnderEmployee()" style="cursor:pointer;">{{$employee[0]->totalSr}}</div>
        <span class="count_bottom">
        <i class="fa fa-sort-asc">
          <i class="red" data-toggle="modal" data-target="#myModalOffSr" style="cursor:pointer;" onclick="getOffSRList()">Off:{{$employee[0]->offSr?$employee[0]->offSr:0}}</i>
          <i class="green">|On:{{$employee[0]->onSr?$employee[0]->onSr:0}}</i>
          <i class="gray">|Act:{{$employee[0]->actSr?$employee[0]->actSr:0}}</i>
        </i>
        </span>
        @else
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" id="outletDiv">
        ...
        <div  style="text-size:15px; font-style:bold;">
          <span  class="count">{{$employee?$employee[0]->totalScheduleCall:0}}</span>out of:
          <span style="font-size:16px; font-weight:bold;">{{$today_open_out?round($today_open_out[0]->opened_outlet_today/6):0}}
          <sub>{{$today_open_out?$today_open_out[0]->opened_outlet_today:0}}</sub></span>
        </div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="">W:{{$out_type_count[0]->Whole_Sale_site?$out_type_count[0]->Whole_Sale_site:0}}</i>
            <i class="">|T:{{$out_type_count[0]->Tong_site?$out_type_count[0]->Tong_site:0}}</i>
            <i class="">|GT:{{$out_type_count[0]->Trade_M_site?$out_type_count[0]->Trade_M_site:0}}</i>
          </i>
        </span>
        
        @else
        <div class="count">{{$employee?$employee[0]->totalScheduleCall:0}}</div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="red">V:{{$employee[0]->total_visited?$employee[0]->total_visited:0}}</i>
            <i class="green">|S:{{$employee[0]->productiveMemo?$employee[0]->productiveMemo:0}}</i>
            <i class="gray">|PE/Olt:{{$employee[0]->APEOIT?$employee[0]->APEOIT:0}}</i>
          </i>
        </span>
        @endif
        @else
      ...
      @if($employee)
      <div class="count"><a href="#" data-toggle="modal" data-target="#myModalVisit" style="cursor:pointer;"  onclick="getCatWiseOutVisit()">{{$employee[0]->total_visited?$employee[0]->total_visited:0}}</a></div>
      <span class="count_bottom">
        <i class="fa fa-sort-asc">
          <i class="">S:{{$employee[0]->productiveMemo?$employee[0]->productiveMemo:0}}</i>
          <i class=""> |PE/OLT:{{$employee[0]->APEOIT?$employee[0]->APEOIT:0}}</i>
        </i>
      </span>
      @else
      <div class="count">0</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        @if($employee)
          ...
          @endphp
        <div class="count">{{number_format($stk_rate,2)}}%</div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="green">-Ve.:{{$employee[0]->nonProductiveSr?$employee[0]->nonProductiveSr:0}}</i>
          </i> 
        </span>
        @else
        <div class="count">0%</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        <div class="nonvisited">
          <p style="margin: 0 0 -6px;">L1M:<span  style="font-size:20px; font-weight:bold;">{{$month1}}</span></p>
          <p style="margin: 0 0 -6px;">L2M:<span style="font-size:20px; font-weight:bold;">{{$month2}}</span></p>
          <p style="margin: 0 0 -6px;">L3M:<span style="font-size:20px; font-weight:bold;">{{$month3}}</span></p>
        </div>
        ...
        @else
        <div class="count">{{$employee?(number_format($employee[0]->lineParCall,2)):0}}</div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="">A.M/SR:{{$employee[0]->AMSR?$employee[0]->AMSR:0}}</i>
          </i> 
        </span>
        @endif
        @else
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
        ...
        @if($employee)
        <div class="count">{{$employee?(number_format($employee[0]->totalOrderAmount,2)):0}}</div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="">Today Tgt:{{$employee[0]->totalTargetAmount?(number_format($employee[0]->totalTargetAmount/26,2)):0}}</i>
          </i> 
        </span>
        @else
        <div class="count">0</div>
      ...
      <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count" id="contributionDiv">
        ...
        @if($employee)
        <div class="count">{{$employee?(number_format($employee[0]->totalOrderAmount/($employee[0]->actSr?$employee[0]->actSr:1),2)):0}}</div>
        <span class="count_bottom">
          <i class="fa fa-sort-asc">
            <i class="">A.Olt/SR:{{$employee[0]->totalScheduleCall?(number_format($employee[0]->totalScheduleCall/($employee[0]->onSr?$employee[0]->onSr:1),2)):0}}</i>
            <i class="">A.V/SR:{{$employee[0]->total_visited?(number_format($employee[0]->total_visited/($employee[0]->onSr?$employee[0]->onSr:1),2)):0}}</i>
          </i>
        </span>
        @else
        <div class="count">0</div>
              ...
              <tr>
                ...
                <td>
                  ...
                  <tr>
                      ...
                      <td>{{$employee?(number_format(($employee[0]->pvSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0}}%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#F5F75A"></i>Negative</p>
                    </td>
                    <td>{{$employee?(number_format(($employee[0]->nveSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0}}%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:lightgreen"></i>Inactive</p>
                    </td>
                    <td>{{$employee?(number_format(($employee[0]->inactSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0}}%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#F9522D"></i>Off </p>
                    </td>
                    <td>{{$employee?(number_format(($employee[0]->offSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0}}%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#A9A9A9"></i>Leave</p>
                    </td>
                    <td>{{$employee?(number_format(($employee[0]->levSr*100/($employee[0]->onSr==0?1:$employee[0]->totalSr)),2)):0}}%</td>
                  </tr>
                  </table>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <tr>
                      ...
                      <td>{{$employee?(number_format(($employee[0]->pvSr*100/($employee[0]->onSr==0?1:$employee[0]->onSr)),2)):0}}%</td>
                  </tr>
                  <tr>
                    <td>
                      <p><i class="fa fa-square" style="color:#F9522D"></i>Non-P. </p>
                    </td>
                    <td>{{$employee?(number_format(($employee[0]->nonProductiveSr*100/($employee[0]->onSr==0?1:$employee[0]->onSr)),2)):0}}%</td>
...
function loadUnderEmployee(f_id) {
    ...
    $.ajax({
        type: "POST",
        url: "{{ URL::to('/')}}/load_under_employee",
        data: {
            _token: _token,
           	emid:emid,
        },
...
function getCatWiseOutVisit(){
  ...
  $.ajax({
    type:"get",
    url:"{{URL::to('/')}}/getCatWiseOutVisit/"+emid,
    dataType: "json",
    success: function (data){
      $('#cat_out_load').hide();
      console.log(data);
...
function getVisitedOutletDetails(emid,cat_id){
  ...
  $.ajax({
        type:"get",
        url:"{{URL::to('/')}}/getVisitedOutletDetailsDashboard/"+emid+"/"+cat_id,
        dataType: "json",
        success: function (data){
